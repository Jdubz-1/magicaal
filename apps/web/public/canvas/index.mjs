...
var E = (i, e, t) => (Qa(i, e, "read from private field"), t ? t.call(i) : e.get(i)), Qe = (i, e, t) => e.has(i) ? _f("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t), ke = (i, e, t, n) => (Qa(i, e, "write to private field"), n ? n.call(i, t) : e.set(i, t), t), Le = (i, e, t) => (Qa(i, e, "access private method"), t);
var Cd;
...
function $c(i) {
  (i.f & wi) !== 0 || i.deps === null ? ht(i, vt) : ht(i, Ii);
}
function Vd(i) {
  if (i !== null)
    for (const e of i)
...
function Bd(i, e, t) {
  (i.f & $t) !== 0 ? e.add(i) : (i.f & Ii) !== 0 && t.add(i), Vd(i.deps), ht(i, vt);
}
function Gd(i, e, t) {
  if (i == null)
    return e(void 0), us;
...
let _a = null, Es = null, ge = null, Vr = null, Tt = null, yh = null, Br = !1, Pa = !1, js = null, ol = null;
var Tf = 0;
let gv = 1;
...
const Ul = class Ul {
   ...
   */
  skip_effect(e) {
    E(this, Ui).has(e) || E(this, Ui).set(e, { d: [], m: [] }), E(this, ir).delete(e);
  }
  /**
  ...
  flush() {
    try {
      Pa = !0, ge = this, Le(this, Ne, Ir).call(this);
    } finally {
      Tf = 0, yh = null, js = null, ol = null, Pa = !1, ge = null, Tt = null, ds.clear();
    }
  }
  discard() {
    for (const e of E(this, er)) e(this);
    E(this, er).clear(), E(this, os).clear(), Le(this, Ne, As).call(this);
  }
  /**
   * @param {Effect} effect
   */
   ...
   */
  increment(e, t) {
    if (ke(this, tr, E(this, tr) + 1), e) {
      let n = E(this, pn).get(t) ?? 0;
      E(this, pn).set(t, n + 1);
    }
  }
  /**
  ...
  decrement(e, t) {
    if (ke(this, tr, E(this, tr) - 1), e) {
      let n = E(this, pn).get(t) ?? 0;
      n === 1 ? E(this, pn).delete(t) : E(this, pn).set(t, n - 1);
    }
    E(this, ls) || (ke(this, ls, !0), Nn(() => {
  ...
  run_fork_commit_callbacks() {
    for (const e of E(this, os)) e(this);
    E(this, os).clear();
  }
  settled() {
    return (E(this, bo) ?? ke(this, bo, Id())).promise;
  }
  static ensure() {
    var e;
    if (ge === null) {
      const t = ge = new Ul();
      Le(e = t, Ne, Sh).call(e), !Pa && !Br && Nn(() => {
        E(t, Ks) || t.flush();
      });
    }
    return ge;
  ...
  schedule(e) {
    ...
    for (var t = e; t.parent !== null; ) {
      t = t.parent;
      var n = t.f;
      if (js !== null && t === Ze && (Ee === null || (Ee.f & Zt) === 0) && !vh)
        return;
      if ((n & (Yn | Li)) !== 0) {
        if ((n & vt) === 0)
          return;
...
Ks = new WeakMap(), Xn = new WeakMap(), rs = new WeakMap(), Js = new WeakMap(), er = new WeakMap(), os = new WeakMap(), tr = new WeakMap(), pn = new WeakMap(), bo = new WeakMap(), li = new WeakMap(), yo = new WeakMap(), jn = new WeakMap(), Gi = new WeakMap(), Ui = new WeakMap(), ir = new WeakMap(), ls = new WeakMap(), Ne = new WeakSet(), wh = function() {
  ...
  var a, h, c, f;
  if (ke(this, Ks, !0), Tf++ > 1e3 && (Le(this, Ne, As).call(this), bv()), !Le(this, Ne, wh).call(this)) {
    for (const d of E(this, jn))
      E(this, Gi).delete(d), ht(d, $t), this.schedule(d);
    for (const d of E(this, Gi))
      ht(d, Ii), this.schedule(d);
  }
  const e = E(this, li);
  ...
  if (js = null, ol = null, Le(this, Ne, wh).call(this)) {
    Le(this, Ne, ll).call(this, n), Le(this, Ne, ll).call(this, t);
    for (const [d, p] of E(this, Ui))
      Jd(d, p);
    s.length > 0 && /** @type {unknown} */
    Le(a = ge, Ne, Ir).call(a);
    return;
  }
  const o = Le(this, Ne, Fd).call(this);
  if (o) {
    Le(h = o, Ne, Hd).call(h, this);
    return;
  }
  E(this, jn).clear(), E(this, Gi).clear();
  for (const d of E(this, Js)) d(this);
  E(this, Js).clear(), Vr = this, Cf(n), Cf(t), Vr = null, (c = E(this, bo)) == null || c.resolve();
  var l = (
    /** @type {Batch | null} */
    /** @type {unknown} */
    ge
  );
  if (this.linked && E(this, tr) === 0 && Le(this, Ne, As).call(this), E(this, li).length > 0) {
    l === null && (l = this, Le(this, Ne, Sh).call(this));
    const d = l;
    E(d, li).push(...E(this, li).filter((p) => !E(d, li).includes(p)));
  }
  l !== null && Le(f = l, Ne, Ir).call(f);
}, /**
...
xh = function(e, t, n) {
  ...
  for (var s = e.first; s !== null; ) {
    var r = s.f, o = (r & (Li | Yn)) !== 0, l = o && (r & vt) !== 0, a = l || (r & zt) !== 0 || E(this, Ui).has(s);
    if (!a && s.fn !== null) {
      o ? s.f ^= vt : (r & sr) !== 0 ? t.push(s) : kr(s) && ((r & Ri) !== 0 && E(this, Gi).add(s), Ss(s));
      var h = s.first;
      if (h !== null) {
        s = h;
        continue;
    ...
    if (r !== null)
      for (const a of r) {
        ...
        if ((o & Zt) !== 0)
          ...
          o & (Ys | Ri) && !this.async_deriveds.has(l) && (E(this, Gi).delete(l), ht(l, $t), this.schedule(l));
        }
      }
  };
  for (const s of this.current.keys())
    t(s);
  this.oncommit(() => e.discard()), Le(n = e, Ne, As).call(n), ge = this, Le(this, Ne, Ir).call(this);
}, /**
 * @param {Effect[]} effects
 */
ll = function(e) {
  for (var t = 0; t < e.length; t += 1)
    Bd(e[t], E(this, jn), E(this, Gi));
}, mv = function() {
  var c;
  Le(this, Ne, As).call(this);
  for (let f = _a; f !== null; f = E(f, rs)) {
    ...
    if (E(f, Ks)) {
      ...
      if (s.length === 0)
        ...
        if (e)
          for (const d of E(this, ir))
            f.unskip_effect(d, (p) => {
              var O;
              (p.f & (Ri | Ys)) !== 0 ? f.schedule(p) : Le(O = f, Ne, ll).call(O, [p]);
            });
        f.activate();
        ...
        if (a.length > 0)
          for (const d of E(this, yo))
            (d.f & (xi | zt | ml)) === 0 && _c(d, a, o) && ((d.f & (Ys | Ri)) !== 0 ? (ht(d, $t), f.schedule(d)) : E(f, jn).add(d));
        if (E(f, li).length > 0 && !E(f, ls)) {
          f.apply();
          for (var h of E(f, li))
            Le(c = f, Ne, xh).call(c, h, [], []);
          ke(f, li, []);
        }
        f.deactivate();
      }
  ...
  if (!t.has(i) && (t.add(i), i.reactions !== null))
    for (const s of i.reactions) {
      ...
      (r & Zt) !== 0 ? Kd(
        ...
        t,
        n
      ) : (r & (Ys | Ri)) !== 0 && (r & $t) === 0 && _c(s, e, n) && (ht(s, $t), Pc(
        /** @type {Effect} */
        s
      ));
    }
...
function Jd(i, e) {
  if (!((i.f & Li) !== 0 && (i.f & vt) !== 0)) {
    (i.f & $t) !== 0 ? e.d.push(i) : (i.f & Ii) !== 0 && e.m.push(i), ht(i, vt);
...
var di, xc, pi, as, Ut, Oi, jt, ai, On, hs, Ln, nr, wo, xo, gn, Fl, dt, kv, Qv, $v, kh, al, hl, Qh, $h;
class Sv {
  /**
  ...
  constructor(e, t, n, s) {
     ...
     */
    Qe(this, gn, null);
    Qe(this, Fl, yv(() => (ke(this, gn, xs(E(this, hs))), () => {
      ke(this, gn, null);
    })));
    var r;
    ...
    Ze.b, this.transform_error = s ?? ((r = this.parent) == null ? void 0 : r.transform_error) ?? ((o) => o), ke(this, Ut, sa(() => {
      Le(this, dt, kh).call(this);
    }, wv));
  }
  /**
  ...
  update_pending_count(e, t) {
    Le(this, dt, Qh).call(this, e, t), ke(this, hs, E(this, hs) + e), !(!E(this, gn) || E(this, nr)) && (ke(this, nr, !0), Nn(() => {
      ke(this, nr, !1), E(this, gn) && ar(E(this, gn), E(this, hs));
    }));
  }
  get_effect_pending() {
    return E(this, Fl).call(this), u(
      /** @type {Source<number>} */
      E(this, gn)
    );
  }
  /** @param {unknown} error */
  error(e) {
    if (!E(this, pi).onerror && !E(this, pi).failed)
      throw e;
    ge != null && ge.is_fork ? (E(this, Oi) && ge.skip_effect(E(this, Oi)), E(this, jt) && ge.skip_effect(E(this, jt)), E(this, ai) && ge.skip_effect(E(this, ai)), ge.on_fork_commit(() => {
      Le(this, dt, $h).call(this, e);
    })) : Le(this, dt, $h).call(this, e);
  }
}
di = new WeakMap(), xc = new WeakMap(), pi = new WeakMap(), as = new WeakMap(), Ut = new WeakMap(), Oi = new WeakMap(), jt = new WeakMap(), ai = new WeakMap(), On = new WeakMap(), hs = new WeakMap(), Ln = new WeakMap(), nr = new WeakMap(), wo = new WeakMap(), xo = new WeakMap(), gn = new WeakMap(), Fl = new WeakMap(), dt = new WeakSet(), kv = function() {
  try {
    ke(this, Oi, gi(() => E(this, as).call(this, E(this, di))));
  } catch (e) {
    this.error(e);
  }
}, /**
...
Qv = function(e) {
  ...
  const e = E(this, pi).pending;
  e && (this.is_pending = !0, ke(this, jt, gi(() => e(E(this, di)))), Nn(() => {
    var t = ke(this, On, document.createDocumentFragment()), n = wn();
    t.append(n), ke(this, Oi, Le(this, dt, hl).call(this, () => gi(() => E(this, as).call(this, n)))), E(this, Ln) === 0 && (E(this, di).before(t), ke(this, On, null), ps(
      /** @type {Effect} */
      E(this, jt),
      () => {
        ke(this, jt, null);
 ...
 */
al = function(e) {
  this.is_pending = !1, e.transfer_effects(E(this, wo), E(this, xo));
}, /**
 * @template T
 * @param {() => T} fn
 */
hl = function(e) {
  var t = Ze, n = Ee, s = rt;
  $i(E(this, Ut)), Qi(E(this, Ut)), or(E(this, Ut).ctx);
  try {
    return ys.ensure(), e();
  } catch (r) {
    return qd(r), null;
...
Qh = function(e, t) {
  ...
  if (!this.has_pending_snippet()) {
    this.parent && Le(n = this.parent, dt, Qh).call(n, e, t);
    return;
  }
  ke(this, Ln, E(this, Ln) + e), E(this, Ln) === 0 && (Le(this, dt, al).call(this, t), E(this, jt) && ps(E(this, jt), () => {
    ke(this, jt, null);
  }), E(this, On) && (E(this, di).before(E(this, On)), ke(this, On, null)));
}, /**
 * @param {unknown} error
 */
$h = function(e) {
  E(this, Oi) && (ti(E(this, Oi)), ke(this, Oi, null)), E(this, jt) && (ti(E(this, jt)), ke(this, jt, null)), E(this, ai) && (ti(E(this, ai)), ke(this, ai, null));
  var t = E(this, pi).onerror;
  let n = E(this, pi).failed;
  var s = !1, r = !1;
  const o = () => {
    if (s) {
      fv();
    ...
    s = !0, r && av(), E(this, ai) !== null && ps(E(this, ai), () => {
      ke(this, ai, null);
    }), Le(this, dt, hl).call(this, () => {
      Le(this, dt, kh).call(this);
    });
  }, l = (a) => {
    try {
      ...
      In(h, E(this, Ut) && E(this, Ut).parent);
    }
    n && ke(this, ai, Le(this, dt, hl).call(this, () => {
      try {
        return gi(() => {
          var h = (
            /** @type {Effect} */
  ...
  Nn(() => {
    ...
    a.then == "function" ? a.then(
      l,
      /** @param {unknown} e */
      (h) => In(h, E(this, Ut) && E(this, Ut).parent)
    ) : l(a);
  });
};
function _v(i, e, t, n) {
...
function bl(i = !0) {
  $i(null), Qi(null), or(null), i && (ge == null || ge.deactivate());
}
function tp() {
  var i = (
    /** @type {Effect} */
...
function ip(i) {
  var e = Tc(i);
  if (!i.equals(e) && (i.wv = vp(), (!(ge != null && ge.is_fork) || i.deps === null) && (ge !== null ? (ge.capture(i, e, !0), Vr == null || Vr.capture(i, e, !0)) : i.v = e, i.deps === null))) {
    ht(i, vt);
    return;
  }
  Sn || (Tt !== null ? (Zc() || ge != null && ge.is_fork) && Tt.set(i, e) : $c(i));
}
function Zv(i) {
  var e, t;
  if (i.effects !== null)
...
function S(i, e, t = !1) {
  ...
  (!Mi || (Ee.f & ml) !== 0) && Sr() && (Ee.f & (Zt | Ri | Ys | ml)) !== 0 && (Si === null || !fs.call(Si, i)) && lv();
  let n = t ? Ls(e) : e;
  return ar(i, n, ol);
}
function ar(i, e, t = null) {
  if (!i.equals(e)) {
    ...
    i.wv = vp(), rp(i, $t, t), Sr() && Ze !== null && (Ze.f & vt) !== 0 && (Ze.f & (Li | Yn)) === 0 && (ui === null ? Wv([i]) : ui.push(i)), !n.is_fork && yl.size > 0 && !sp && Ev();
  }
  return e;
}
function Ev() {
    ...
    for (var s = Sr(), r = n.length, o = 0; o < r; o++) {
      ...
      if (!(!s && l === Ze)) {
        ...
        if (h && ht(l, e), (a & ml) !== 0)
          ...
          Tt == null || Tt.delete(c), (a & bs) === 0 && (a & wi && (Ze === null || (Ze.f & vl) === 0) && (l.f |= bs), rp(c, Ii, t));
        } else if (h) {
          var f = (
            /** @type {Effect} */
            l
  ...
  return n && t.set("length", /* @__PURE__ */ Tn(
    ...
    i,
    {
      ...
      has(l, a) {
        ...
        if (h !== void 0 || Ze !== null && (!c || (d = Ns(l, a)) != null && d.writable)) {
          h === void 0 && (h = o(() => {
      ...
      set(l, a, h, c) {
        ...
        if (n && a === "length")
          ...
          f.v; p += 1) {
            var O = t.get(p + "");
            O !== void 0 ? S(O, yt) : p in l && (O = o(() => /* @__PURE__ */ Tn(yt)), t.set(p + "", O));
          }
        if (f === void 0)
          (!d || (x = Ns(l, a)) != null && x.writable) && (f = o(() => /* @__PURE__ */ Tn(void 0)), S(f, Ls(h)), t.set(a, f));
        else {
          d = f.v !== yt;
          var g = o(() => Ls(h));
          S(f, g);
...
function hn(i, e) {
  ...
  if (s !== null && (s.parent = t, t !== null && Lv(s, t), Ee !== null && (Ee.f & Zt) !== 0 && (i & Yn) === 0)) {
    var r = (
      /** @type {Derived} */
      Ee
    );
...
function Pi() {
  ...
  Ps(() => {
    for (var e of i.l.$) {
      e.deps();
      var t = e.effect;
      (t.f & vt) !== 0 && t.deps !== null && ht(t, Ii), kr(t) && Ss(t), e.ran = !1;
    }
  });
}
function zv(i) {
...
function Op(i, e) {
  if ((i.f & zt) !== 0) {
    i.f ^= zt, (i.f & vt) === 0 && (ht(i, $t), ys.ensure().schedule(i));
    for (var t = i.first; t !== null; ) {
...
let Si = null;
function gp(i) {
  Ee !== null && (Si === null ? Si = [i] : Si.push(i));
}
  ...
  if (n !== null && !(Si !== null && fs.call(Si, i)))
    for (var s = 0; s < n.length; s++) {
      ...
      (r.f & Zt) !== 0 ? bp(
        ...
        e,
        !1
      ) : e === r && (t ? ht(r, $t) : (r.f & vt) !== 0 && ht(r, Ii), Pc(
        /** @type {Effect} */
        r
      ));
    }
...
function yp(i) {
  var g;
  var e = Ft, t = oi, n = ui, s = Ee, r = Si, o = rt, l = Mi, a = Os, h = i.f;
  Ft = /** @type {null | Value[]} */
  null, oi = 0, ui = null, Ee = (h & (Li | Yn)) === 0 ? i : null, Si = null, or(i.ctx), Mi = !1, Os = ++ns, i.ac !== null && (ta(() => {
    i.ac.abort(ea);
  }), i.ac = null);
  try {
    i.f |= vl;
    ...
    i.f ^= vl, Ft = e, oi = t, ui = n, Ee = s, Si = r, or(o), Mi = l, Os = a;
  }
}
function qv(i, e) {
  let t = e.reactions;
...
function u(i) {
  var e = i.f, t = (e & Zt) !== 0;
  if (Ee !== null && !Mi) {
    var n = Ze !== null && (Ze.f & xi) !== 0;
    if (!n && (Si === null || !fs.call(Si, i))) {
      var s = Ee.deps;
      if ((Ee.f & vl) !== 0)
        i.rv < ns && (i.rv = ns, Ft === null && s !== null && s[oi] === i ? oi++ : Ft === null ? Ft = [i] : Ft.push(i));
      else {
        Ee.deps ?? (Ee.deps = []), fs.call(Ee.deps, i) || Ee.deps.push(i);
        var r = i.reactions;
        r === null ? i.reactions = [Ee] : fs.call(r, Ee) || r.push(Ee);
      }
    }
  }
  if (Sn && ds.has(i))
  ...
  if (t) {
    ...
    var a = (o.f & wi) === 0 && !Mi && Ee !== null && (cl || (Ee.f & wi) !== 0), h = (o.f & _s) === 0;
...
class kp {
  ...
  constructor(e, t = !0) {
    ...
    Qe(this, ko, (e) => {
      if (E(this, Ei).has(e)) {
        ...
        if (n)
          Ac(n), E(this, cs).delete(t);
        else {
          var s = E(this, hi).get(t);
          s && (E(this, Fi).set(t, s.effect), E(this, hi).delete(t), s.fragment.lastChild.remove(), this.anchor.before(s.fragment), n = s.effect);
        }
        for (const [r, o] of E(this, Ei)) {
          if (E(this, Ei).delete(r), r === e)
            break;
          const l = E(this, hi).get(o);
          l && (ti(l.effect), E(this, hi).delete(o));
        }
        for (const [r, o] of E(this, Fi)) {
          if (r === t || E(this, cs).has(r)) continue;
          const l = () => {
            if (Array.from(E(this, Ei).values()).includes(r)) {
              var h = document.createDocumentFragment();
              Rc(o, h), h.append(wn()), E(this, hi).set(r, { effect: o, fragment: h });
            } else
              ti(o);
            E(this, cs).delete(r), E(this, Fi).delete(r);
          };
          E(this, So) || !n ? (E(this, cs).add(r), ps(o, l, !1)) : l();
        }
      }
    });
    /**
    ...
    Qe(this, Hl, (e) => {
      E(this, Ei).delete(e);
      const t = Array.from(E(this, Ei).values());
      for (const [n, s] of E(this, hi))
        t.includes(n) || (ti(s.effect), E(this, hi).delete(n));
    });
   ...
   */
    ...
    if (t && !E(this, Fi).has(e) && !E(this, hi).has(e))
      if (s) {
        var r = document.createDocumentFragment(), o = wn();
        r.append(o), E(this, hi).set(e, {
          effect: gi(() => t(o)),
          fragment: r
        });
      } else
    ...
    if (E(this, Ei).set(n, e), s) {
      for (const [l, a] of E(this, Fi))
        l === e ? n.unskip_effect(a) : n.skip_effect(a);
      for (const [l, a] of E(this, hi))
        l === e ? n.unskip_effect(a.effect) : n.skip_effect(a.effect);
      n.oncommit(E(this, ko)), n.ondiscard(E(this, Hl));
    } else
      E(this, ko).call(this, n);
  }
}
...
function et(i, e, t, n, s, r = null) {
  ...
  var v = sa(() => {
    d = /** @type {V[]} */
    u(f);
    for (var x = d.length, M = /* @__PURE__ */ new Set(), T = (
      /** @type {Batch} */
      ge
    ), R = hp(), Z = 0; Z < x; Z += 1) {
      var z = d[Z], D = n(z, Z), L = O ? null : l.get(D);
      L ? (L.v && ar(L.v, z), L.i && ar(L.i, Z), R && T.unskip_effect(L.e)) : (L = a0(
        l,
        O ? o : Lf ?? (Lf = wn()),
        z,
        D,
...
function l0(i, e, t, n, s) {
  var L, W, k, P, _, $, X, C, ee;
  var r = (n & Mm) !== 0, o = e.length, l = i.items, a = Zr(i.effect.first), h, c = null, f, d = [], p = [], O, g, m, v;
  if (r)
    for (v = 0; v < o; v += 1)
      O = e[v], g = s(O, v), m = /** @type {EachItem} */
      l.get(g).e, (m.f & Ji) === 0 && ((W = (L = m.nodes) == null ? void 0 : L.a) == null || W.measure(), (f ?? (f = /* @__PURE__ */ new Set())).add(m));
  for (v = 0; v < o; v += 1) {
    ...
    if ((m.f & zt) !== 0 && (Ac(m), r && ((P = (k = m.nodes) == null ? void 0 : k.a) == null || P.unfix(), (f ?? (f = /* @__PURE__ */ new Set())).delete(m))), (m.f & Ji) !== 0)
      if (m.f ^= Ji, m === a)
        Dr(m, null, t);
      else {
        var Q = c ? c.next : a;
    ...
    if (m !== a) {
      if (h !== void 0 && h.has(m)) {
        if (d.length < p.length) {
          var x = p[0], M;
          c = x.prev;
          var T = d[0], R = d[d.length - 1];
          for (M = 0; M < d.length; M += 1)
            Dr(d[M], x, t);
          for (M = 0; M < p.length; M += 1)
            h.delete(p[M]);
          Cn(i, T.prev, R.next), Cn(i, c, T), Cn(i, R, x), a = x, c = R, v -= 1, d = [], p = [];
        } else
  ...
  if (i.outrogroups !== null) {
    for (const ie of i.outrogroups)
      ie.pending.size === 0 && (Zh(i, Jl(ie.done)), (_ = i.outrogroups) == null || _.delete(ie));
  ...
  if (a !== null || h !== void 0) {
    ...
    if (h !== void 0)
      for (m of h)
        (m.f & zt) === 0 && Z.push(m);
    for (; a !== null; )
      (a.f & zt) === 0 && a !== i.fallback && Z.push(a), a = Zr(a.next);
    var z = Z.length;
    if (z > 0) {
      var D = (n & Ad) !== 0 && o === 0 ? t : null;
      if (r) {
        for (v = 0; v < z; v += 1)
          (X = ($ = Z[v].nodes) == null ? void 0 : $.a) == null || X.measure();
        for (v = 0; v < z; v += 1)
          (ee = (C = Z[v].nodes) == null ? void 0 : C.a) == null || ee.fix();
      }
      o0(i, Z, D);
    }
  }
  r && Nn(() => {
    ...
    if (f !== void 0)
      for (m of f)
        (H = (ie = m.nodes) == null ? void 0 : ie.a) == null || H.apply();
  });
}
...
function wl(i, e, t = e) {
  ...
  Cc(i, "change", (r) => {
    ...
    t(l), i.__value = l, ge !== null && n.add(ge);
  }), na(() => {
    var r = e();
...
function It(i, e, t = e) {
  ...
  Cc(i, "input", async (s) => {
    ...
    if (r = Ca(i) ? Za(r) : r, t(r), ge !== null && n.add(ge), await Vv(), r !== (r = e())) {
  ...
  b(e) == null && i.value && (t(Ca(i) ? Za(i.value) : i.value), ge !== null && n.add(ge)), Ps(() => {
    var s = e();
    if (i === document.activeElement) {
      var r = (
        /** @type {Batch} */
...
function ze(i, e, t, n) {
  ...
  if (r) {
    ...
    f = ((M = Ns(i, e)) == null ? void 0 : M.set) ?? (d && e in i ? (T) => i[e] = T : void 0);
  }
  var p, O = !1;
  r ? [p, O] = Ov(() => (
    /** @type {V} */
  ...
  if (s ? g = () => {
    ...
    return T === void 0 ? c() : (a = !0, T);
  } : g = () => {
    var T = (
      /** @type {V} */
      i[e]
    );
    return T !== void 0 && (l = /** @type {V} */
    void 0), T === void 0 ? l : T;
  }, s && (t & Im) === 0)
    return g;
  if (f) {
    ...
    return (
      /** @type {() => V} */
      (function(T, R) {
        return arguments.length > 0 ? ((!s || !R || m || O) && f(R ? g() : T), T) : g();
      })
    );
  }
  ...
  return (
    ...
    (function(T, R) {
      if (arguments.length > 0) {
        const Z = R ? u(Q) : s && r ? Ls(T) : T;
        return S(Q, Z), v = !0, l !== void 0 && (l = Z), T;
      }
...
function K1(i, e) {
  ...
  var o = H1(), l = w(o);
  {
    var a = (p) => {
      var O = G1();
      te("click", O, () => r("autoPlacement")), A(p, O);
    };
    J(l, (p) => {
      t() || p(a);
    });
...
function ay(i, e) {
  St(e, !1);
  const t = () => ct(ot, "$graph", o), n = () => ct(ha, "$canUndoAutoPlacement", o), s = () => ct(Po, "$canUndoCaalChange", o), r = () => ct(Wn, "$selectedNode", o), [o, l] = $n(), a = /* @__PURE__ */ q();
  ze(e, "agentId", 8);
  ...
  let p = /* @__PURE__ */ q([]), O = /* @__PURE__ */ q([]), g = /* @__PURE__ */ q([]), m = null, v = { x: 0, y: 0 }, Q = /* @__PURE__ */ q(), x = /* @__PURE__ */ q({ x: 0, y: 0, w: 1e3, h: 600 }), M = !1, T = { mx: 0, my: 0, vbx: 0, vby: 0 }, R = /* @__PURE__ */ q(null), Z = /* @__PURE__ */ q({ x: 0, y: 0 }), z = /* @__PURE__ */ q(null), D = /* @__PURE__ */ q({ x: 0, y: 0 }), L = /* @__PURE__ */ q(""), W = /* @__PURE__ */ q(!1), k = /* @__PURE__ */ q(!1);
  function P(N) {
    Wn.set(N);
  }
  function _(N) {
  ...
  function $(N, j) {
    ...
    ne.x = N, ne.y = j;
    const fe = ne.matrixTransform(u(Q).getScreenCTM().inverse());
  ...
  function C(N) {
    N.preventDefault();
    const j = N.deltaY > 0 ? 1.1 : 0.9, ne = u(Q).getBoundingClientRect(), fe = (N.clientX - ne.left) / ne.width * u(x).w + u(x).x, Re = (N.clientY - ne.top) / ne.height * u(x).h + u(x).y;
    S(x, {
      x: fe - (fe - u(x).x) * j,
      y: Re - (Re - u(x).y) * j,
      w: u(x).w * j,
  ...
  function ee(N) {
    const j = N.target;
    j.closest("g") || j.tagName === "circle" || (M = !0, T = {
      mx: N.clientX,
      my: N.clientY,
      vbx: u(x).x,
      vby: u(x).y
  ...
  function ie(N, j) {
    if (h()) return;
    const ne = $(N.clientX, N.clientY), fe = j.position ?? { x: 100, y: 100 };
    m = j, v = { x: ne.x - fe.x, y: ne.y - fe.y };
  }
  function H(N, j) {
    if (h()) return;
    const ne = $(N.clientX, N.clientY);
    S(R, { fromNodeId: j, x: ne.x, y: ne.y }), S(Z, ne);
  }
  function U(N) {
    if (u(R) && u(R).fromNodeId !== N) {
      const j = u(Q).getBoundingClientRect();
      S(D, {
        x: (u(Z).x - u(x).x) / u(x).w * j.width,
        y: (u(Z).y - u(x).y) / u(x).h * j.height
      }), S(z, { from: u(R).fromNodeId, to: N });
    }
    S(R, null);
  }
  function le(N) {
    if (M) {
      const j = u(x).w / u(Q).clientWidth, ne = u(x).h / u(Q).clientHeight;
      S(x, {
        ...u(x),
        x: T.vbx - (N.clientX - T.mx) * j,
        y: T.vby - (N.clientY - T.my) * ne
      });
    }
    if (m) {
      const j = $(N.clientX, N.clientY), ne = m.id;
      ot.update((fe) => ({
        ...fe,
        nodes: {
          ...fe.nodes,
    ...
    u(R) && S(Z, $(N.clientX, N.clientY));
  }
  function se() {
    var N;
    if (m) {
      const j = (N = t().nodes[m.id]) == null ? void 0 : N.position;
      j && w0(m.id, j);
    }
    M = !1, m = null, S(R, null);
  }
  ...
  function be(N) {
    ...
    const j = (Se = N.dataTransfer) == null ? void 0 : Se.getData(c);
    if (!j) return;
    const { type: ne, name: fe } = JSON.parse(j), Re = $(N.clientX, N.clientY), Ge = {
      x: Re.x - cr / 2,
      y: Re.y - fr / 2
    };
    Tp(ne, fe, Ge);
  ...
  function ae() {
    const N = Object.values(t().nodes).map((Se) => Se.position).filter((Se) => !!Se);
    if (N.length === 0) return;
    const j = 60, ne = Math.min(...N.map((Se) => Se.x)) - j, fe = Math.min(...N.map((Se) => Se.y)) - j, Re = Math.max(...N.map((Se) => Se.x + cr)) + j, Ge = Math.max(...N.map((Se) => Se.y + fr)) + j;
    S(x, {
      x: ne,
      y: fe,
      w: Math.max(Re - ne, 200),
      h: Math.max(Ge - fe, 150)
    });
  }
  function we() {
    V1(), ae();
  ...
  qe(() => t(), () => {
    ...
    () => (Xe(h()), u(p), u(k)),
    () => {
      h() && u(p).length > 0 && !u(k) && (ae(), S(k, !0));
    }
  ), qe(() => u(g), () => {
    S(a, u(g).reduce(
      (N, j) => (N[j.to] = (N[j.to] ?? 0) + 1, N),
      {}
    ));
  }), Pi(), _t();
  var V = ly(), oe = w(V);
  K1(oe, {
    ...
    $$events: {
      autoPlacement: we,
      undo(...N) {
        Da == null || Da.apply(this, N);
      },
      undoCaal: () => tO()
    }
  });
  var ce = y(oe, 2), Oe = y(w(ce));
  et(Oe, 1, () => u(O), Je, (N, j) => {
    const ne = /* @__PURE__ */ wt(() => (u(j), b(() => _(u(j).from)))), fe = /* @__PURE__ */ wt(() => (u(j), b(() => _(u(j).to))));
    var Re = J1();
    G(() => {
      nt(Re, "x1", (Xe(u(ne)), b(() => u(ne).x + 160))), nt(Re, "y1", (Xe(u(ne)), b(() => u(ne).y + 20))), nt(Re, "x2", (Xe(u(fe)), b(() => u(fe).x))), nt(Re, "y2", (Xe(u(fe)), b(() => u(fe).y + 20))), nt(Re, "stroke", (u(j), b(() => u(j).type === "fallback" ? "#94a3b8" : "#7c6af7"))), nt(Re, "stroke-dasharray", (u(j), b(() => u(j).type === "fallback" ? "4" : "0")));
    }), A(N, Re);
  });
  var pe = y(Oe);
  et(pe, 1, () => u(g), Je, (N, j) => {
    ...
    {
      var Re = (Ge) => {
        const Se = /* @__PURE__ */ wt(() => (u(j), b(() => _(u(j).from)))), K = /* @__PURE__ */ wt(() => (u(j), b(() => _(u(j).to))));
        var ue = ey();
        G(() => {
          nt(ue, "x1", (Xe(u(Se)), b(() => u(Se).x + 160))), nt(ue, "y1", (Xe(u(Se)), b(() => u(Se).y + 20))), nt(ue, "x2", (Xe(u(K)), b(() => u(K).x))), nt(ue, "y2", (Xe(u(K)), b(() => u(K).y + 20)));
        }), A(Ge, ue);
      };
      J(fe, (Ge) => {
        t(), u(j), b(() => t().nodes[u(j).from]) && Ge(Re);
      });
    }
    A(N, ne);
  });
  var $e = y(pe);
  et($e, 1, () => u(p), Je, (N, j) => {
    const ne = /* @__PURE__ */ wt(() => (u(j), b(() => u(j).position ?? { x: 100, y: 100 }))), fe = /* @__PURE__ */ wt(() => (u(j), b(() => f.has(u(j).type)))), Re = /* @__PURE__ */ wt(() => (u(j), b(() => d.has(u(j).type)))), Ge = /* @__PURE__ */ wt(() => (r(), u(j), b(() => {
      var pt;
      return ((pt = r()) == null ? void 0 : pt.id) === u(j).id;
    }))), Se = /* @__PURE__ */ wt(() => (u(a), u(j), b(() => u(a)[u(j).id] ?? 0)));
    var K = iy(), ue = w(K), ye = y(ue), Ye = w(ye), Me = y(ye), _e = w(Me), Ue = y(Me);
    {
      var xe = (pt) => {
    ...
    var Pe = y(Ue), Wt = y(Pe);
    G(() => {
      nt(K, "transform", `translate(${Xe(u(ne)), b(() => u(ne).x) ?? ""},${Xe(u(ne)), b(() => u(ne).y) ?? ""})`), nt(ue, "fill", u(Ge) ? u(fe) ? "#2d1f00" : "#312e7a" : u(fe) ? "#1e1600" : "#1e2035"), nt(ue, "stroke", u(Ge) ? u(fe) ? "#f59e0b" : "#7c6af7" : u(fe) ? "#b45309" : "#2d3148"), nt(ue, "stroke-width", u(fe) ? "2" : "1.5"), B(Ye, (u(j), b(() => u(j).type))), B(_e, (u(j), b(() => u(j).label ?? u(j).id)));
    }), te("mousedown", Pe, Aa((pt) => H(pt, u(j).id))), te("mouseup", Wt, Aa(() => U(u(j).id))), te("click", K, () => P(u(j))), te("keydown", K, (pt) => pt.key === "Enter" && P(u(j))), te("mousedown", K, Aa((pt) => ie(pt, u(j)))), A(N, K);
  });
  var He = y($e);
  {
    var je = (N) => {
      var j = ny();
      G(() => {
        nt(j, "x1", (u(R), b(() => u(R).x))), nt(j, "y1", (u(R), b(() => u(R).y))), nt(j, "x2", (u(Z), b(() => u(Z).x))), nt(j, "y2", (u(Z), b(() => u(Z).y)));
      }), A(N, j);
    };
    J(He, (N) => {
      u(R) && N(je);
  ...
  Lc(ce, (N) => S(Q, N), () => u(Q)), h0(ce, (N, j) => X == null ? void 0 : X(N, j), () => C), na(() => te("mousedown", ce, ee));
  var it = y(ce, 2);
  {
    var Be = (N) => {
      var j = ry(), ne = w(j), fe = y(ne, 2), Re = y(fe, 2), Ge = y(Re, 2);
      {
        var Se = (ue) => {
          var ye = sy(), Ye = De(ye), Me = y(Ye, 2);
          It(Ye, () => u(L), (_e) => S(L, _e)), te("click", Me, () => Ce("conditional", u(L))), A(ue, ye);
        };
        J(Ge, (ue) => {
          u(W) && ue(Se);
        });
      ...
      var K = y(Ge, 2);
      G(() => $p(j, `left:${u(D), b(() => u(D).x) ?? ""}px;top:${u(D), b(() => u(D).y) ?? ""}px`)), te("click", ne, () => Ce("unconditional")), te("click", fe, () => Ce("fallback")), te("click", Re, () => {
        S(W, !u(W));
      }), te("click", K, () => {
        S(z, null), S(W, !1);
      }), A(N, j);
  ...
  var mt = y(it, 2);
  {
    ...
    J(mt, (N) => {
      u(p), b(() => u(p).length === 0) && N(Te);
    });
  }
  G(() => nt(ce, "viewBox", `${u(x), b(() => u(x).x) ?? ""} ${u(x), b(() => u(x).y) ?? ""} ${u(x), b(() => u(x).w) ?? ""} ${u(x), b(() => u(x).h) ?? ""}`)), te("mousemove", V, le), te("mouseup", V, se), te("mouseleave", V, se), te("dragover", V, de), te("drop", V, be), A(i, V), kt(), l();
}
const Fr = Qn([]), Wc = Qn([]);
let za = !1;
async function iO() {
...
function py(i, e) {
  St(e, !1);
  const t = () => ct(Fr, "$nodeTypes", s), n = () => ct(Wc, "$connections", s), [s, r] = $n(), o = /* @__PURE__ */ q(), l = /* @__PURE__ */ q();
  ...
  function g(Z) {
    ...
    for (const D of Z) {
      const L = D.meta.category ?? "other";
      z.has(L) || z.set(L, []), z.get(L).push(D);
    }
    return Array.from(z.entries()).map(([D, L]) => ({
      category: D,
      label: O[D] ?? D,
      items: L
    }));
  ...
  async function m() {
    try {
      ...
      if (!Z.ok) return;
      const z = await Z.json(), D = z.map((L) => L.type).sort().join(",");
      D !== d && (d = D, Fr.set(z));
    } catch {
      t().length === 0 && Fr.set([
        {
  ...
  function v(Z) {
    var D, L;
    const z = (L = (D = Z.schema) == null ? void 0 : D.config) == null ? void 0 : L.properties;
    if (z) {
  ...
  function M(Z, z, D) {
    ...
    (L = Z.dataTransfer) == null || L.setData(h, JSON.stringify({ type: z, name: D })), Z.dataTransfer && (Z.dataTransfer.effectAllowed = "copy");
  }
  qe(() => t(), () => {
    S(o, g(t()));
  }), qe(() => n(), () => {
    S(l, new Set(n().map((Z) => Z.service)));
  }), Pi(), _t();
  var T = dy(), R = y(w(T), 2);
  et(R, 1, () => u(o), Je, (Z, z) => {
    var D = uy(), L = De(D), W = w(L), k = y(L, 2);
    et(k, 1, () => (u(z), b(() => u(z).items)), Je, ($, X) => {
      var C = cy();
      let ee;
      var ie = w(C), H = w(ie), U = y(H);
      {
        var le = (ae) => {
          var we = hy();
          G((Ce) => nt(we, "title", `No ${Ce ?? ""} connection configured`), [
            () => (u(X), b(() => v(u(X))))
          ]), A(ae, we);
        }, se = /* @__PURE__ */ ws(() => (u(X), u(l), b(() => Q(u(X), u(l)))));
        J(U, (ae) => {
          u(se) && ae(le);
        });
      }
      var de = y(ie, 2), be = w(de);
      G(() => {
        ee = Jt(C, 1, "palette-item svelte-142uvrg", null, ee, { readonly: a() }), C.disabled = a(), nt(C, "draggable", !a()), B(H, `${u(X), b(() => u(X).meta.name) ?? ""} `), B(be, (u(X), b(() => u(X).type)));
      }), te("dragstart", C, (ae) => M(ae, u(X).type, u(X).meta.name)), te("click", C, () => x(u(X).type, u(X).meta.name)), A($, C);
    });
    var P = y(k, 2);
    {
      var _ = ($) => {
        var X = fy();
        G(() => nt(X, "href", `/admin/marketplace?category=${u(z), b(() => u(z).category) ?? ""}`)), A($, X);
      };
      J(P, ($) => {
        u(p) && $(_);
      });
    }
    G(() => B(W, (u(z), b(() => u(z).label)))), A(Z, D);
  }), A(i, T), kt(), r();
}
let Rh = [], nO = [];
(() => {
...
let Ie = class lO {
  ...
  */
  static of(e) {
    ...
    return e.length == 1 && !e[0] ? lO.empty : e.length <= 32 ? new Ot(e) : Hi.from(Ot.split(e, []));
  }
};
class Ot extends Ie {
  ...
  decompose(e, t, n, s) {
    let r = e <= 0 && t >= this.length ? this : new Ot(au(this.text, e, t), Math.min(t, this.length) - Math.max(0, e));
    if (s & 1) {
...
class ve {
  ...
  */
  static define(e = {}) {
    return new ve(e.combine || ((t) => t), e.compareInput || ((t, n) => t === n), e.compare || (e.combine ? (t, n) => t === n : Vc), !!e.static, e.enables);
  }
  /**
  ...
  dynamicSlot(e) {
    ...
    return {
      ...
      reconfigure: (f, d) => {
        ...
        if (O != null) {
          let g = _l(d, O);
          if (this.dependencies.every((m) => m instanceof ve ? d.facet(m) === f.facet(m) : m instanceof cn ? d.field(m, !1) == f.field(m, !1) : !0) || (l ? hu(p = n(f), g, s) : s(p = n(f), g)))
...
const Do = /* @__PURE__ */ ve.define({ static: !0 });
class cn {
  constructor(e, t, n, s, r) {
...
const dO = /* @__PURE__ */ ve.define(), Dh = /* @__PURE__ */ ve.define({
  combine: (i) => i.some((e) => e),
  static: !0
}), pO = /* @__PURE__ */ ve.define({
  combine: (i) => i.length ? i[0] : void 0,
  static: !0
}), OO = /* @__PURE__ */ ve.define(), gO = /* @__PURE__ */ ve.define(), mO = /* @__PURE__ */ ve.define(), vO = /* @__PURE__ */ ve.define({
...
function bO(i, e, t) {
  ...
  return t ? (s = e.changes, r = xt.empty(e.changes.length), o = i.changes.compose(e.changes)) : (s = e.changes.map(i.changes), r = i.changes.mapDesc(e.changes, !0), o = i.changes.compose(s)), {
    ...
    effects: Fe.mapEffects(i.effects, s).concat(Fe.mapEffects(e.effects, r)),
...
function Py(i) {
  ...
  if (t !== !0) {
    ...
    i = bt.create(e, s, i.selection && i.selection.map(r), Fe.mapEffects(i.effects, r), i.annotations, i.scrollIntoView);
  }
  let n = e.facet(gO);
  ...
  */
  applyTransaction(e) {
    ...
    for (let l of e.effects)
      l.is(ca.reconfigure) ? (t && (s = /* @__PURE__ */ new Map(), t.compartments.forEach((a, h) => s.set(h, a)), t = null), s.set(l.value.compartment, l.value.extension)) : l.is(Fe.reconfigure) ? (t = null, n = l.value) : l.is(Fe.appendConfig) && (t = null, n = Vs(n).concat(l.value));
    let r;
  ...
  changeByRange(e) {
    ...
    for (let l = 1; l < t.ranges.length; l++) {
      ...
      for (let d = 0; d < l; d++)
        r[d] = r[d].map(c);
      let f = s.mapDesc(h, !0);
      r.push(a.range.map(f)), s = s.compose(c), o = Fe.mapEffects(o, c).concat(Fe.mapEffects(Vs(a.effects), f));
    }
    return {
      changes: s,
...
We.tabSize = /* @__PURE__ */ ve.define({
  combine: (i) => i.length ? i[0] : 4
});
We.lineSeparator = pO;
We.readOnly = vO;
We.phrases = /* @__PURE__ */ ve.define({
  compare(i, e) {
...
ca.reconfigure = /* @__PURE__ */ Fe.define();
function Bc(i, e, t = {}) {
  let n = {};
  for (let s of i)
...
class Ve {
  ...
  */
  update(e) {
    ...
    return c.finishInner(this.nextLayer.isEmpty && !h.length ? Ve.empty : this.nextLayer.update({ add: h, filter: o, filterFrom: s, filterTo: r }));
  }
  /**
  ...
  */
  map(e) {
    ...
    return t.length == 0 ? r : new Ve(n, t, r || Ve.empty, s);
  }
  /**
  ...
  */
  static join(e) {
    ...
    for (let n = e.length - 2; n >= 0; n--)
      for (let s = e[n]; s != Ve.empty; s = s.nextLayer)
        t = new Ve(s.chunkPos, s.chunk, t, Math.max(s.maxPoint, t.maxPoint));
    return t;
  }
}
Ve.empty = /* @__PURE__ */ new Ve([], [], null, -1);
function Ry(i) {
  if (i.length > 1)
  ...
  */
  finishInner(e) {
    if (this.from.length && this.finishChunk(!1), this.chunks.length == 0)
      return e;
    let t = Ve.create(this.chunkPos, this.chunks, this.nextLayer ? this.nextLayer.finishInner(e) : e, this.setMaxPoint);
...
let es = null;
he.safari && he.safari_version >= 26 && (es = !1);
function _O(i) {
  if (i.setActive)
    return i.setActive();
  if (es)
...
function Hy(i, e, t, n, s) {
  for (let r = 0; r <= n.length; r++) {
    ...
    for (let h = o, c = a, f = a; h < l; h++) {
      ...
      d == 512 ? d = c : d == 8 && f == 4 && (d = 16), Ke[h] = d == 4 ? 2 : d, d & 7 && (f = d), c = d;
    }
    for (let h = o, c = a, f = a; h < l; h++) {
      let d = Ke[h];
      if (d == 128)
        h < l - 1 && c == Ke[h + 1] && c & 24 ? d = Ke[h] = c : Ke[h] = 256;
      else if (d == 64) {
        let p = h + 1;
        for (; p < l && Ke[p] == 64; )
          p++;
        let O = h && c == 8 || p < t && Ke[p] == 8 ? f == 1 ? 1 : 8 : 256;
        for (let g = h; g < p; g++)
          Ke[g] = O;
        h = p - 1;
      } else d == 8 && f == 1 && (Ke[h] = 1);
      ...
      if (h == 256) {
        ...
        for (; ; )
          if (c == l) {
            ...
            break;
        let f = r == 1, d = (c < e ? Ke[c] : n) == 1, p = f == d ? f ? 1 : 2 : n;
        for (let O = c, g = s, m = g ? t[g - 1].to : i; O > a; )
          O == m && (O = t[--g].from, m = g ? t[g - 1].to : i), Ke[--O] = p;
        a = c;
      } else
        r = h, a++;
    }
...
const XO = /* @__PURE__ */ ve.define(), jO = /* @__PURE__ */ ve.define(), LO = /* @__PURE__ */ ve.define(), IO = /* @__PURE__ */ ve.define(), ic = /* @__PURE__ */ ve.define(), DO = /* @__PURE__ */ ve.define(), zO = /* @__PURE__ */ ve.define(), Jc = /* @__PURE__ */ ve.define(), ef = /* @__PURE__ */ ve.define(), NO = /* @__PURE__ */ ve.define({
  combine: (i) => i.some((e) => e)
}), nw = /* @__PURE__ */ ve.define({
  combine: (i) => i.some((e) => e)
}), YO = /* @__PURE__ */ ve.define();
class Us {
...
const Yo = /* @__PURE__ */ Fe.define({ map: (i, e) => i.map(e) }), WO = /* @__PURE__ */ Fe.define();
function fi(i, e, t) {
  let n = i.facet(IO);
  n.length ? n[0](e) : window.onerror && window.onerror(String(e), t, void 0, void 0, e) || (t ? console.error(t + ":", e) : console.error(e));
}
const vn = /* @__PURE__ */ ve.define({ combine: (i) => i.length ? i[0] : !0 });
let sw = 0;
const Ds = /* @__PURE__ */ ve.define({
  combine(i) {
    return i.filter((e, t) => {
      for (let n = 0; n < t; n++)
...
const qO = /* @__PURE__ */ ve.define(), tf = /* @__PURE__ */ ve.define(), da = /* @__PURE__ */ ve.define(), VO = /* @__PURE__ */ ve.define(), nf = /* @__PURE__ */ ve.define(), Eo = /* @__PURE__ */ ve.define(), BO = /* @__PURE__ */ ve.define();
function xu(i, e) {
  let t = i.state.facet(BO);
  if (!t.length)
    return t;
  let n = t.map((r) => r instanceof Function ? r(i) : r), s = [];
  return Ve.spans(n, e.from, e.to, {
    point() {
    },
    span(r, o, l, a) {
...
class ss extends ut {
  ...
  coordsIn(e, t, n) {
    ...
    e > s && (e = s);
    let r = e, o = e, l = 0;
    e == 0 && t < 0 || e == s && t >= 0 ? he.chrome || he.gecko || (e ? (r--, l = 1) : o < s && (o++, l = -1)) : t < 0 ? r-- : o < s && o++;
    let a = Oo(this.dom, r, o).getClientRects();
    if (!a.length)
      return null;
    let h = a[(l ? l < 0 : t >= 0) ? 0 : a.length - 1];
    return he.safari && !l && h.width == 0 && (h = Array.prototype.find.call(a, (c) => c.width) || h), n == null ? h : po(h, (l ? l > 0 : t < 0) == n);
  }
  static of(e, t) {
...
class cw {
  ...
  endLine() {
    if (this.curLine) {
      ...
      (!e || !ku(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(he.ios && ku(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(
        Ga,
        0,
        32
        /* TileFlag.After */
...
class dw {
  constructor(e, t, n, s, r) {
    this.view = e, this.decorations = s, this.disallowBlockEffectsFor = r, this.openWidget = !1, this.openMarks = 0, this.cache = new uw(e), this.text = new fw(e.state.doc), this.builder = new cw(this.cache, new Oa(e, e.contentDOM), Ve.iter(n)), this.cache.reused.set(
      t,
      2
      /* Reused.DOM */
  ...
  emit(e, t) {
    let n = null, s = this.builder, r = -1, o = Ve.spans(this.decorations, e, t, {
      point: (l, a, h, c, f, d) => {
        if (h instanceof ks) {
...
class Qu {
  ...
  update(e) {
    ...
    this.hasComposition = r ? { from: r.range.fromB, to: r.range.toB } : null, (he.ie || he.chrome) && !r && e && e.state.doc.lines != e.startState.doc.lines && (this.forceSelection = !0);
  ...
  updateInner(e, t) {
    ...
    n.ignore(() => {
      ...
      let r = he.chrome || he.ios ? { node: n.selectionRange.focusNode, written: !1 } : void 0;
  ...
  updateSelection(e = !1, t = !1) {
    ...
    if (a.empty ? c = h = this.inlineDOMNearPos(a.anchor, a.assoc || 1) : (c = this.inlineDOMNearPos(a.head, a.head == a.from ? 1 : -1), h = this.inlineDOMNearPos(a.anchor, a.anchor == a.from ? 1 : -1)), he.gecko && a.empty && !this.hasComposition && mw(h)) {
    ...
    (l || !f.focusNode || (!to(h.node, h.offset, f.anchorNode, f.anchorOffset) || !to(c.node, c.offset, f.focusNode, f.focusOffset)) && !this.suppressWidgetCursorChange(f, a)) && (this.view.observer.ignore(() => {
      he.android && he.chrome && n.contains(f.focusNode) && kw(f.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
  ...
  measureVisibleLineHeights(e) {
    let t = [], { from: n, to: s } = e, r = this.view.contentDOM.clientWidth, o = r > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, l = -1, a = this.view.textDirection == ft.LTR, h = 0, c = (f, d, p) => {
      for (let O = 0; O < f.children.length && !(d > s); O++) {
        ...
        if (p && !O && (h += v.top - p.top), g instanceof xn)
          ...
          if (M.length) {
            let T = M[M.length - 1], R = a ? T.right - v.left : v.right - T.left;
  ...
  updateDeco() {
    ...
    for (s.length && (this.dynamicDecorationMap[e++] = n, t.push(Ve.join(s))), this.decorations = [
  ...
  scrollIntoView(e) {
    ...
    if (Wy(this.view.scrollDOM, o, t.head < t.anchor ? -1 : 1, e.x, e.y, Math.max(Math.min(e.xMargin, l), -l), Math.max(Math.min(e.yMargin, a), -a), this.view.textDirection == ft.LTR), window.visualViewport && window.innerHeight - window.visualViewport.height > 1 && (n.top > window.pageYOffset + window.visualViewport.offsetTop + window.visualViewport.height || n.bottom < window.pageYOffset + window.visualViewport.offsetTop)) {
...
function ww(i, e, t) {
  let n = new yw();
  return Ve.compare(i, e, t, n), n.changes;
}
class xw {
  constructor() {
    this.changes = [];
        ...
        for (let v = 0; v < m.length; v++) {
          ...
          if (!(Q.width == 0 && m.length > 1)) {
            if (Q.bottom < this.y)
              ...
              let M = Q.left > this.x ? this.x - Q.left : Q.right < this.x ? this.x - Q.right : 0, T = Math.abs(M);
              T < f && (c = g, f = T, d = Q), M && (x = M < 0 == (this.baseDir == ft.LTR) ? -1 : 1);
            }
...
class Xw {
  constructor(e, t, n, s) {
    ...
    if (e.state.readOnly && t > -1)
      ...
      if ((he.ios || he.chrome) && h != c && Math.min(h, c) <= l.main.from && Math.max(h, c) >= l.main.to && (f.from > 0 || f.to < e.state.doc.length)) {
...
function JO(i, e) {
  ...
  if (e.bounds) {
    ...
    (o === 8 || he.android && e.text.length < a - l) && (h = r.to, c = "end");
    ...
    } : (p = eg(f, e.text, h - l, c)) && (he.chrome && o == 13 && p.toB == p.from + 2 && e.text.slice(p.from, p.toB) == Xs + Xs && p.toB--, t = {
      from: l + p.from,
      to: l + p.toA,
...
function rf(i, e, t, n = -1) {
  if (he.ios && i.inputState.flushIOSKey(e))
    return !0;
  let s = i.state.selection.main;
  if (he.android && (e.to == s.to && // GBoard will sometimes remove a space it just inserted
...
class Dw {
  ...
  keydown(e) {
    if (this.lastKeyCode = e.keyCode, this.lastKeyTime = Date.now(), e.keyCode == 9 && this.tabFocusMode > -1 && (!this.tabFocusMode || Date.now() <= this.tabFocusMode))
      return !0;
    if (this.tabFocusMode > 0 && e.keyCode != 27 && ig.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), he.android && he.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8))
      return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
    if (he.ios && !e.synthetic && !e.altKey && !e.metaKey && (tg.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey || Yw.indexOf(e.key) > -1 && e.ctrlKey)) {
      let t = { ctrlKey: e.ctrlKey, altKey: e.altKey, metaKey: e.metaKey, shiftKey: e.shiftKey };
      return t.shiftKey && he.ios && !/^(off|none)$/.test(this.view.contentDOM.autocapitalize) && zw(this.view.win) && (t.shiftKey = !1), this.pendingIOSKey = { key: e.key, keyCode: e.keyCode, mods: t }, setTimeout(() => this.flushIOSKey(), 250), !0;
    }
  ...
  ignoreDuringComposition(e) {
    return !/^key/.test(e.type) || e.synthetic ? !1 : this.composing > 0 ? !0 : he.safari && !he.ios && this.compositionPendingKey && Date.now() - this.compositionEndedAt < 100 ? (this.compositionPendingKey = !1, !0) : !1;
  }
...
function Vw(i, e) {
  ...
  return t.length ? t[0](e) : he.mac ? e.metaKey : e.ctrlKey;
}
function Bw(i, e) {
  let t = i.state.facet(jO);
  return t.length ? t[0](e) : he.mac ? !e.altKey : !e.ctrlKey;
}
function Gw(i, e) {
...
const Di = /* @__PURE__ */ Object.create(null), Yt = /* @__PURE__ */ Object.create(null), ng = he.ie && he.ie_version < 15 || he.ios && he.webkit_version < 604;
function Fw(i) {
...
Yt.scroll = (i) => {
  let e = i.inputState;
  e.lastScrollTop = i.scrollDOM.scrollTop, e.lastScrollLeft = i.scrollDOM.scrollLeft, he.ios && !e.touchActive && (e.lastIOSMomentumScroll = Date.now());
};
...
const Hw = he.ie && he.ie_version <= 11;
...
Yt.compositionend = (i) => {
  i.observer.editContext || (i.inputState.composing = -1, i.inputState.compositionEndedAt = Date.now(), i.inputState.compositionPendingKey = !0, i.inputState.compositionPendingChange = i.observer.pendingRecords().length > 0, i.inputState.compositionFirstChange = null, he.chrome && he.android ? i.observer.flushSoon() : i.inputState.compositionPendingChange ? Promise.resolve().then(() => i.observer.flush()) : setTimeout(() => {
...
Di.beforeinput = (i, e) => {
  ...
  let s;
  if (he.chrome && he.android && (s = tg.find((r) => r.inputType == e.inputType)) && (i.observer.delayAndroidKey(s.key, s.keyCode), s.key == "Backspace" || s.key == "Delete")) {
  ...
  return he.ios && e.inputType == "deleteContentForward" && i.observer.flushSoon(), he.safari && e.inputType == "insertText" && i.inputState.composing >= 0 && setTimeout(() => Yt.compositionend(i, e), 20), !1;
};
...
class Nt {
  ...
  applyChanges(e, t, n, s) {
    ...
    for (let l = s.length - 1; l >= 0; l--) {
      let { fromA: a, toA: h, fromB: c, toB: f } = s[l], d = r.lineAt(a, st.ByPosNoHeight, n.setDoc(t), 0, 0), p = d.to >= h ? d : r.lineAt(h, st.ByPosNoHeight, n, 0, 0);
      for (f += p.to - h, h = p.to; l > 0 && d.from <= s[l - 1].toA; )
        a = s[l - 1].fromA, c = s[l - 1].fromB, l--, a < d.from && (d = r.lineAt(a, st.ByPosNoHeight, n, 0, 0));
      c += d.from - a, a = d.from;
...
class ox extends Nt {
  ...
  lineAt(e, t, n, s, r) {
    let o = s + this.left.height, l = r + this.left.length + this.break, a = t == st.ByHeight ? e < o : e < l, h = a ? this.left.lineAt(e, t, n, s, r) : this.right.lineAt(e, t, n, o, l);
...
class of {
  ...
  static build(e, t, n, s) {
    let r = new of(n, e);
    return Ve.spans(t, n, s, r, 0), r.finish(n);
  }
}
function ax(i, e, t) {
  let n = new hx();
  return Ve.compare(i, e, t, n, 0), n.changes;
}
class hx {
  constructor() {
    this.changes = [];
...
class Lu {
  constructor(e, t) {
    this.view = e, this.state = t, this.pixelViewport = { left: 0, right: window.innerWidth, top: 0, bottom: 0 }, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = Iu, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = ft.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
  ...
  measure() {
    ...
    if ((this.contentDOMWidth != x || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = e.scrollDOM.clientHeight, h |= 16), a) {
      ...
      if (s.mustRefreshForHeights(T) && (o = !0), o || s.lineWrapping && Math.abs(x - this.contentDOMWidth) > s.charWidth) {
        let { lineHeight: R, charWidth: Z, textHeight: z } = e.docView.measureTextSize();
        o = R > 0 && s.refresh(r, R, Z, z, Math.max(5, x / Z), T), o && (e.docView.minWidth = 0, h |= 16);
      }
      m > 0 && v > 0 ? c = Math.max(m, v) : m < 0 && v < 0 && (c = Math.min(m, v)), Xu();
      for (let R of this.viewports) {
        let Z = R.from == this.viewport.from ? T : e.docView.measureVisibleLineHeights(R);
        this.heightMap = (o ? Nt.empty().applyChanges(this.stateDeco, Ie.empty, this.heightOracle, [new vi(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(s, 0, o, new sx(R.from, Z));
      }
      mr && (h |= 2);
    }
  ...
  getViewport(e, t) {
    let n = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)), s = this.heightMap, r = this.heightOracle, { visibleTop: o, visibleBottom: l } = this, a = new Vo(s.lineAt(o - n * 1e3, st.ByHeight, r, 0, 0).from, s.lineAt(l + (1 - n) * 1e3, st.ByHeight, r, 0, 0).to);
    if (t) {
      let { head: h } = t.range;
      if (h < a.from || h > a.to) {
        let c = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), f = s.lineAt(h, st.ByPos, r, 0, 0), d;
        t.y == "center" ? d = (f.top + f.bottom) / 2 - c / 2 : t.y == "start" || t.y == "nearest" && h < a.from ? d = f.top : d = f.bottom - c, a = new Vo(s.lineAt(d - 1e3 / 2, st.ByHeight, r, 0, 0).from, s.lineAt(d + c + 1e3 / 2, st.ByHeight, r, 0, 0).to);
      }
    }
    return a;
  }
  mapViewport(e, t) {
    ...
    return new Vo(this.heightMap.lineAt(n, st.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(s, st.ByPos, this.heightOracle, 0, 0).to);
  }
  ...
  viewportIsAppropriate({ from: e, to: t }, n = 0) {
    if (!this.inView)
      return !0;
    let { top: s } = this.heightMap.lineAt(e, st.ByPos, this.heightOracle, 0, 0), { bottom: r } = this.heightMap.lineAt(t, st.ByPos, this.heightOracle, 0, 0), { visibleTop: o, visibleBottom: l } = this;
  ...
  ensureLineGaps(e, t) {
    ...
    let l = [], a = (c, f, d, p) => {
      ...
      if (n) {
        ...
        let Q = this.pixelViewport.left + v, x = this.pixelViewport.right + v, M, T;
        if (d != null) {
          let R = Go(f, d), Z = ((x - Q) / 2 + m) / g;
          M = R - Z, T = R + Z;
        } else
          M = (Q - m) / g, T = (x + m) / g;
        p = Bo(f, M), O = Bo(f, T);
  ...
  updateLineGaps(e) {
    Ha.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = tt.set(e.map((t) => t.draw(this, this.heightOracle.lineWrapping))));
  }
  computeVisibleRanges(e) {
    let t = this.stateDeco;
    this.lineGaps.length && (t = t.concat(this.lineGapDeco));
    let n = [];
    Ve.spans(t, this.viewport.from, this.viewport.to, {
      span(r, o) {
        n.push({ from: r, to: o });
      },
      point() {
  ...
  lineBlockAt(e) {
    return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || Yr(this.heightMap.lineAt(e, st.ByPos, this.heightOracle, 0, 0), this.scaler);
  }
  lineBlockAtHeight(e) {
    return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || Yr(this.heightMap.lineAt(this.scaler.fromDOM(e), st.ByHeight, this.heightOracle, 0, 0), this.scaler);
  }
  getScrollOffset() {
...
function Du(i) {
  ...
  return t.length && e.push(Ve.join(t)), e;
}
class lf {
  constructor(e, t, n) {
    let s = 0, r = 0, o = 0;
    this.viewports = n.map(({ from: l, to: a }) => {
      let h = t.lineAt(l, st.ByPos, e, 0, 0).top, c = t.lineAt(a, st.ByPos, e, 0, 0).bottom;
...
const Uo = /* @__PURE__ */ ve.define({ combine: (i) => i.join(" ") }), oc = /* @__PURE__ */ ve.define({ combine: (i) => i.indexOf(!0) > -1 }), lc = /* @__PURE__ */ pr.newName(), cg = /* @__PURE__ */ pr.newName(), fg = /* @__PURE__ */ pr.newName(), ug = { "&light": "." + cg, "&dark": "." + fg };
function ac(i, e, t) {
  return new pr(e, {
    finish(n) {
...
class vx {
  constructor(e) {
    this.view = e, this.active = !1, this.editContext = null, this.selectionRange = new qy(), this.selectionChanged = !1, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.flushingAndroidKey = -1, this.lastChange = 0, this.scrollTargets = [], this.intersection = null, this.resizeScroll = null, this.intersecting = !1, this.gapIntersection = null, this.gaps = [], this.printQuery = null, this.parentCheck = -1, this.dom = e.contentDOM, this.observer = new MutationObserver((t) => {
      for (let n of t)
        this.queue.push(n);
      (he.ie && he.ie_version <= 11 || he.ios && e.composing) && t.some((n) => n.type == "childList" && n.removedNodes.length || n.type == "characterData" && n.oldValue.length > n.target.nodeValue.length) ? this.flushSoon() : this.flush();
    }), window.EditContext && he.android && e.constructor.EDIT_CONTEXT !== !1 && // Chrome <126 doesn't support inverted selections in edit context (#1392)
    !(he.chrome && he.chrome_version < 126) && (this.editContext = new yx(e), e.state.facet(vn) && (e.contentDOM.editContext = this.editContext.editContext)), Ka && (this.onCharData = (t) => {
      this.queue.push({
        target: t.target,
        type: "characterData",
  ...
  onSelectionChange(e) {
    ...
    (he.ie && he.ie_version <= 11 || he.android && he.chrome) && !n.state.selection.main.empty && // (Selection.isCollapsed isn't reliable on IE)
  ...
  readSelectionRange() {
    ...
    if (!t)
      return !1;
    let n = he.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && bx(this.view, t) || t;
...
`))
      ...
      if ((he.mac || he.android) && f.from == o - 1 && /^\. ?$/.test(n.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (f = { from: l, to: a, insert: Ie.of([n.text.replace(".", " ")]) }), this.pendingContextChange = f, !e.state.readOnly) {
      ...
      for (let r of n.getTextFormats()) {
        ...
        if (!/none/i.test(o) && !/none/i.test(l)) {
          ...
          if (a < h) {
            ...
            s.push(tt.mark({ attributes: { style: c } }).range(a, h));
          }
        }
      }
      e.dispatch({ effects: WO.of(tt.set(s)) });
...
class me {
        ...
        if (d && this.docView.updateSelection(!0), !f.viewportChanged && this.measureRequests.length == 0) {
          if (this.viewState.editorHeight)
            if (this.viewState.scrollTarget) {
              ...
              if ((O > 1 || O < -1) && !(he.ios && this.inputState.lastIOSMomentumScroll > Date.now() - 100) && (n == this.scrollDOM || this.hasFocus || Math.max(this.inputState.lastWheelEvent, this.inputState.lastTouchTime) > Date.now() - 100)) {
  ...
  */
  get hasFocus() {
    var e;
    return (this.dom.ownerDocument.hasFocus() || he.safari && ((e = this.inputState) === null || e === void 0 ? void 0 : e.lastContextMenu) > Date.now() - 3e4) && this.root.activeElement == this.contentDOM;
  }
  /**
...
me.styleModule = Nr;
me.inputHandler = DO;
me.clipboardInputFilter = Jc;
me.clipboardOutputFilter = ef;
me.scrollHandler = YO;
me.focusChangeEffect = zO;
me.perLineTextDirection = NO;
me.exceptionSink = IO;
me.updateListener = ic;
me.editable = vn;
me.mouseSelectionStyle = LO;
me.dragMovesSelection = jO;
me.clickAddsSelectionRange = XO;
me.decorations = da;
me.blockWrappers = VO;
me.outerDecorations = nf;
me.atomicRanges = Eo;
me.bidiIsolatedRanges = BO;
...
me.contentAttributes = tf;
me.editorAttributes = qO;
me.lineWrapping = /* @__PURE__ */ me.contentAttributes.of({ class: "cm-lineWrapping" });
me.announce = /* @__PURE__ */ Fe.define();
const wx = 4096, Yu = {};
class Xl {
  constructor(e, t, n, s, r, o) {
...
const xx = he.mac ? "mac" : he.windows ? "win" : he.linux ? "linux" : "key";
function Sx(i, e) {
  const t = i.split(/-(?!$)/);
  let n = t[t.length - 1];
  n == "Space" && (n = " ");
...
const kx = /* @__PURE__ */ To.default(/* @__PURE__ */ me.domEventHandlers({
  keydown(i, e) {
    return Px(Qx(e.state), i, e, "editor");
  }
})), ma = /* @__PURE__ */ ve.define({ enables: kx }), qu = /* @__PURE__ */ new WeakMap();
function Qx(i) {
...
function Px(i, e, t, n) {
  ...
  !(he.windows && e.ctrlKey && e.altKey) && // Alt-combinations on macOS tend to be typed characters
  !(he.mac && e.altKey && !(e.ctrlKey || e.metaKey)) && (O = Vn[e.keyCode]) && O != s ? (d(p[l + Fo(O, e, !0)]) || e.shiftKey && (g = co[e.keyCode]) != s && g != O && d(p[l + Fo(g, e, !1)])) && (a = !0) : o && e.shiftKey && d(p[l + Fo(s, e, !0)]) && (a = !0), !a && d(p._any) && (a = !0)), h && (a = !0), a && c && e.stopPropagation(), hc = null, a;
}
class Tx extends $r {
  constructor(e) {
...
function Cx(i) {
  let e = an.fromClass(class {
    constructor(t) {
      this.view = t, this.placeholder = i ? tt.set([tt.widget({ widget: new Tx(i), side: 1 }).range(0)]) : tt.none;
    }
    get decorations() {
...
const Ja = /* @__PURE__ */ ve.define({
  combine: (i) => {
    var e, t, n;
    return {
      position: he.ios ? "absolute" : ((e = i.find((s) => s.position)) === null || e === void 0 ? void 0 : e.position) || "fixed",
  ...
  writeMeasure(i) {
    ...
    for (let l = 0; l < this.manager.tooltips.length; l++) {
      ...
      let p = a.arrow ? h.dom.querySelector(".cm-tooltip-arrow") : null, O = p ? 7 : 0, g = d.right - d.left, m = (e = Vu.get(h)) !== null && e !== void 0 ? e : d.bottom - d.top, v = h.offset || Rx, Q = this.view.textDirection == ft.LTR, x = d.width > n.right - n.left ? Q ? n.left : n.right - d.width : Q ? Math.max(n.left, Math.min(f.left - (p ? 14 : 0) + v.x, n.right - g)) : Math.min(Math.max(n.left, f.left - g + (p ? 14 : 0) - v.x), n.right - g), M = this.above[l];
      !a.strictSide && (M ? f.top - m - O - v.y < n.top : f.bottom + m + O + v.y > n.bottom) && M == n.bottom - f.bottom > f.top - n.top && (M = this.above[l] = !M);
      let T = (M ? f.top - n.top : n.bottom - f.bottom) - O;
      if (T < m && h.resize !== !1) {
        if (T < this.view.defaultLineHeight) {
          c.style.top = Ho;
          continue;
        }
        Vu.set(h, m), c.style.height = (m = T) / r + "px";
      } else c.style.height && (c.style.height = "");
      let R = M ? f.top - m - O - v.y : f.bottom + O + v.y, Z = x + g;
      if (h.overlap !== !0)
        for (let z of o)
          z.left < Z && z.right > x && z.top < R + m && z.bottom > R && (R = M ? z.top - m - 2 - O : z.bottom + O + 2);
      if (this.position == "absolute" ? (c.style.top = (R - i.parent.top) / r + "px", Bu(c, (x - i.parent.left) / s)) : (c.style.top = R / r + "px", Bu(c, x / s)), p) {
        let z = f.left + (Q ? v.x : -v.x) - (x + 14 - 7);
        p.style.left = z / s + "px";
      }
      h.overlap !== !0 && o.push({ left: x, top: R, right: Z, bottom: R + m }), c.classList.toggle("cm-tooltip-above", M), c.classList.toggle("cm-tooltip-below", !M), h.positioned && h.positioned(i.space);
    }
  }
  maybeMeasure() {
...
const Ax = /* @__PURE__ */ me.baseTheme({
  ".cm-tooltip": {
    zIndex: 500,
    boxSizing: "border-box"
  },
...
}), Rx = { x: 0, y: 0 }, pg = /* @__PURE__ */ ve.define({
  enables: [dg, Ax]
});
function Og(i, e) {
  let t = i.plugin(dg);
...
class gt {
  ...
  */
  iterate(e) {
    let { enter: t, leave: n, from: s = 0, to: r = this.length } = e, o = e.mode || 0, l = (o & at.IncludeAnonymous) > 0;
  ...
  */
  balance(e = {}) {
    return this.children.length <= 8 ? this : ff(ni.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, s) => new gt(this.type, t, n, s, this.propValues), e.makeTree || ((t, n, s) => new gt(ni.none, t, n, s)));
  }
  /**
...
class ii extends vg {
  ...
  nextChild(e, t, n, s, r = 0) {
    for (let o = this; ; ) {
      for (let { children: l, positions: a } = o._tree, h = t > 0 ? l.length : -1; e != h; e += t) {
        ...
        if (!(!(r & at.EnterBracketed && c instanceof gt && (d = no.get(c)) && !d.overlay && d.bracketed && n >= f && n <= f + c.length) && !mg(s, n, f, f + c.length))) {
          if (c instanceof Gn) {
          ...
          } else if (r & at.IncludeAnonymous || !c.type.isAnonymous || cf(c)) {
            let p;
            if (!(r & at.IgnoreMounts) && (p = no.get(c)) && !p.overlay)
              return new ii(p.tree, f, e, o);
            let O = new ii(c, f, e, o);
            return r & at.IncludeAnonymous || !O.type.isAnonymous ? O : O.nextChild(t < 0 ? c.children.length - 1 : 0, t, n, s, r);
          }
        }
      }
      if (r & at.IncludeAnonymous || !o.type.isAnonymous || (o.index >= 0 ? e = o.index + t : e = t < 0 ? -1 : o._parent._tree.children.length, o = o._parent, !o))
        return null;
    }
  }
  get firstChild() {
  ...
  enter(e, t, n = 0) {
    let s;
    if (!(n & at.IgnoreOverlays) && (s = no.get(this._tree)) && s.overlay) {
      let r = e - this.from, o = n & at.EnterBracketed && s.bracketed;
...
class fc {
  ...
  */
  constructor(e, t = 0) {
    if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~at.EnterBracketed, e instanceof ii)
      this.yieldNode(e);
    else {
    ...
    for (; n; { index: t, _parent: n } = n)
      if (t > -1)
        for (let r = t + e, o = e < 0 ? -1 : n._tree.children.length; r != o; r += e) {
          ...
          if (this.mode & at.IncludeAnonymous || l instanceof Gn || !l.type.isAnonymous || cf(l))
            return !1;
        }
    return !0;
  }
...
function Dx(i) {
  ...
  function f(T, R, Z, z, D, L) {
    let { id: W, start: k, end: P, size: _ } = l, $ = c, X = h;
    if (_ < 0)
      if (l.next(), _ == -1) {
        let U = r[W];
        Z.push(U), z.push(k - T);
    ...
    let C = a[W], ee, ie, H = k - T;
    if (P - k <= s && (ie = m(l.pos - R, D))) {
      let U = new Uint16Array(ie.size - ie.skip), le = l.pos - ie.size, se = U.length;
      for (; l.pos > le; )
        se = v(ie.start, U, se);
      ee = new Gn(U, P - ie.start, n), H = ie.start - T;
    } else {
      let U = l.pos - _;
      l.next();
      let le = [], se = [], de = W >= o ? W : -1, be = 0, ae = P;
      for (; l.pos > U; )
        de >= 0 && l.id == de && l.size >= 0 ? (l.end <= ae - s && (O(le, se, k, be, l.end, ae, de, $, X), be = le.length, ae = l.end), l.next()) : L > 2500 ? d(k, U, le, se) : f(k, U, le, se, de, L + 1);
      if (de >= 0 && be > 0 && be < le.length && O(le, se, k, be, k, ae, de, $, X), le.reverse(), se.reverse(), de > -1 && be > 0) {
        let we = p(C, X);
        ee = ff(C, le, se, 0, le.length, 0, P - k, we, we);
      } else
        ee = g(C, le, se, P - k, $ - P, X);
    }
    Z.push(ee), z.push(H);
  }
  function d(T, R, Z, z) {
    let D = [], L = 0, W = -1;
    for (; l.pos > R; ) {
      let { id: k, start: P, end: _, size: $ } = l;
      if ($ > 4)
        l.next();
      else {
        if (W > -1 && P < W)
          break;
        W < 0 && (W = _ - s), D.push(k, P, _), L++, l.next();
      }
    }
    if (L) {
      let k = new Uint16Array(L * 4), P = D[D.length - 2];
      for (let _ = D.length - 3, $ = 0; _ >= 0; _ -= 3)
        k[$++] = D[_], k[$++] = D[_ + 1] - P, k[$++] = D[_ + 2] - P, k[$++] = $;
      Z.push(new Gn(k, D[2] - P, n)), z.push(P - T);
    }
  }
  function p(T, R) {
    return (Z, z, D) => {
      let L = 0, W = Z.length - 1, k, P;
      if (W >= 0 && (k = Z[W]) instanceof gt) {
        if (!W && k.type == T && k.length == D)
          return k;
        (P = k.prop(Ae.lookAhead)) && (L = z[W] + k.length + P);
      }
      return g(T, Z, z, D, L, R);
    };
  }
  function O(T, R, Z, z, D, L, W, k, P) {
    let _ = [], $ = [];
    for (; T.length > z; )
      _.push(T.pop()), $.push(R.pop() + Z - D);
    T.push(g(n.types[W], _, $, L - D, k - L, P)), R.push(D - Z);
  }
  function g(T, R, Z, z, D, L, W) {
    if (L) {
      let k = [Ae.contextHash, L];
      W = W ? [k].concat(W) : [k];
    }
    if (D > 25) {
      let k = [Ae.lookAhead, D];
      W = W ? [k].concat(W) : [k];
    }
    return new gt(T, R, Z, z, W);
  }
  function m(T, R) {
    let Z = l.fork(), z = 0, D = 0, L = 0, W = Z.end - s, k = { size: 0, start: 0, skip: 0 };
    e: for (let P = Z.pos - T; Z.pos > P; ) {
      let _ = Z.size;
      if (Z.id == R && _ >= 0) {
        k.size = z, k.start = D, k.skip = L, L += 4, z += 4, Z.next();
        continue;
      }
      let $ = Z.pos - _;
      if (_ < 0 || $ < P || Z.start < W)
    ...
    return (R < 0 || z == T) && (k.size = z, k.start = D, k.skip = L), k.size > 4 ? k : void 0;
  }
  function v(T, R, Z) {
    let { id: z, start: D, end: L, size: W } = l;
    if (l.next(), W >= 0 && z < o) {
      let k = Z;
      if (W > 4) {
        let P = l.pos - (W - 4);
  ...
  return new gt(a[i.topID], Q.reverse(), x.reverse(), M);
}
  ...
  function p(O, g, m, v, Q) {
    for (let x = m; x < v; ) {
      ...
      if (x == M + 1) {
        if (R > c) {
          let Z = O[M];
          p(Z.children, Z.positions, 0, Z.children.length, g[M] + Q);
          continue;
        }
        f.push(O[M]);
      } else {
        let Z = g[x - 1] + O[x - 1].length - T;
        f.push(ff(i, O, g, M, x, T, Z, null, a));
      }
      d.push(T + Q - r);
    }
  }
...
const re = mi.define, Jo = re(), En = re(), Hu = re(En), Ku = re(En), An = re(), el = re(An), th = re(An), Bi = re(), Kn = re(Bi), qi = re(), Vi = re(), uc = re(), Rr = re(uc), tl = re(), Y = {
  /**
  A comment.
  */
  comment: Jo,
  ...
  */
  operatorKeyword: re(qi),
  /**
  A control-flow related [keyword](#highlight.tags.keyword).
  */
  controlKeyword: re(qi),
  /**
  A [keyword](#highlight.tags.keyword) that defines something.
  */
  definitionKeyword: re(qi),
  /**
  ...
  */
  bitwiseOperator: re(Vi),
  /**
  Comparison [operator](#highlight.tags.operator).
  */
  compareOperator: re(Vi),
  /**
  [Operator](#highlight.tags.operator) that updates its operand.
  */
  updateOperator: re(Vi),
  /**
  [Operator](#highlight.tags.operator) that defines something.
  */
  definitionOperator: re(Vi),
  /**
...
var ih;
const Wr = /* @__PURE__ */ new Ae();
function xg(i) {
  return ve.define({
    combine: i ? (e) => e.concat(i) : void 0
  });
}
const uf = /* @__PURE__ */ new Ae();
class sn {
  /**
...
sn.setState = /* @__PURE__ */ Fe.define();
function Ju(i, e, t) {
  let n = i.facet(yr), s = _i(i).topNode;
  if (!n || n.allowsNesting)
    for (let r = s; r; r = r.enter(e, t, at.ExcludeBuffers | at.EnterBracketed))
      r.type.isTop && (s = r);
  return s;
}
class Il extends sn {
...
class Dl {
  ...
  */
  static create(e, t, n) {
    return new Dl(e, t, [], gt.empty, 0, n, [], null);
  }
  startParse() {
  ...
  */
  changes(e, t) {
    ...
    if (this.takeTree(), !e.empty) {
      let a = [];
      if (e.iterChangedRanges((h, c, f, d) => a.push({ fromA: h, toA: c, fromB: f, toB: d })), n = gs.applyChanges(n, a), s = gt.empty, r = 0, o = { from: e.mapPos(o.from, -1), to: e.mapPos(o.to, 1) }, this.skipped.length) {
        l = [];
      ...
      createParse(t, n, s) {
        ...
        return {
          ...
          advance() {
            ...
            return this.parsedPos = o, new gt(ni.none, [], [], o - r);
          },
          stoppedAt: null,
          stopAt() {
          }
...
const Kx = /* @__PURE__ */ ve.define(), va = /* @__PURE__ */ ve.define({
  combine: (i) => {
    if (!i.length)
      return "  ";
    let e = i[0];
...
}), cS = /* @__PURE__ */ tt.mark({ class: "cm-matchingBracket" }), fS = /* @__PURE__ */ tt.mark({ class: "cm-nonmatchingBracket" });
function uS(i) {
...
const Oc = /* @__PURE__ */ _n.define(), TS = /* @__PURE__ */ _n.define(), CS = /* @__PURE__ */ ve.define(), Eg = /* @__PURE__ */ ve.define({
  combine(i) {
    return Bc(i, {
      minDepth: 100,
      newGroupDelay: 500,
...
function LS(i, e, t) {
  ...
  return new ei(s, Fe.mapEffects(i.effects, e), o, i.startSelection.map(r), n);
}
...
class on {
  ...
  addChanges(e, t, n, s, r) {
    ...
    n == "input.type.compose") ? o = Yl(o, o.length - 1, s.minDepth, new ei(e.changes.compose(l.changes), Mg(Fe.mapEffects(e.effects, l.changes), l.effects), l.mapped, l.startSelection, bi)) : o = Yl(o, o.length, s.minDepth, e), new on(o, bi, t, n);
  }
...
function xa(i, e, t) {
  let n = _i(i).resolveInner(e.head), s = t ? Ae.closedBy : Ae.openedBy;
  for (let a = e.head; ; ) {
...
function qg(i, e) {
  ...
  if (t.selfScroll) {
    ...
    o && o.top > a && o.bottom < h && (r = me.scrollIntoView(s.main.head, { y: "start", yMargin: o.top - a }));
  }
...
let lh = null;
function gd(i, e, t) {
  let n = i.cursor(at.IncludeAnonymous);
  for (n.moveTo(e); ; )
  ...
  advanceStack(e, t, n) {
    ...
    if (this.fragments) {
      ...
      for (let f = this.fragments.nodeAt(s); f; ) {
        ...
        if (d > -1 && f.length && (!h || (f.prop(Ae.contextHash) || 0) == c))
...
const Bl = /* @__PURE__ */ Fe.define(), mo = /* @__PURE__ */ Fe.define();
class $Q {
  constructor(e) {
  ...
  match(e) {
    ...
    for (let Q = 0, x = Math.min(e.length, 200), M = 0; Q < x && f < a; ) {
      let T = Jn(e, Q);
      l < 0 && (c < a && T == t[c] && (r[c++] = Q), p < a && (T == t[p] || T == n[p] ? (p == 0 && (O = Q), g = Q + 1, p++) : p = 0));
      let R, Z = T < 255 ? T >= 48 && T <= 57 || T >= 97 && T <= 122 ? 2 : T >= 65 && T <= 90 ? 1 : 0 : (R = xy(T)) != R.toLowerCase() ? 1 : R != R.toUpperCase() ? 2 : 0;
      (!Q || Z == 1 && m || M == 0 && Z != 0) && (t[f] == T || n[f] == T && (d = !0) ? o[f++] = Q : o.length && (v = !1)), M = Z, Q += Ms(T);
    }
...
function PQ(i, e, t, n, s, r) {
  let o = i.textDirection == ft.RTL, l = o, a = !1, h = "top", c, f, d = e.left - s.left, p = s.right - e.right, O = n.right - n.left, g = n.bottom - n.top;
...
}), VQ = typeof navigator == "object" && /* @__PURE__ */ /Win/.test(navigator.platform), BQ = /* @__PURE__ */ To.highest(/* @__PURE__ */ me.domEventHandlers({
  keydown(i, e) {
...
let UQ = /* @__PURE__ */ tt.widget({ widget: /* @__PURE__ */ new class extends $r {
  toDOM() {
...
}() }), FQ = /* @__PURE__ */ tt.mark({ class: "cm-snippetField" });
class Pr {
  constructor(e, t) {
    this.ranges = e, this.active = t, this.deco = tt.set(e.map((n) => (n.from == n.to ? UQ : FQ).range(n.from, n.to)), !0);
  }
  map(e) {
    let t = [];
...
const Mo = /* @__PURE__ */ Fe.define({
  map(i, e) {
    return i && i.map(e);
  }
}), HQ = /* @__PURE__ */ Fe.define(), vo = /* @__PURE__ */ cn.define({
  create() {
    return null;
  },
  update(i, e) {
...
function KQ(i) {
  ...
  return (t, n, s, r) => {
    ...
    if (l.length && (h.selection = kf(l, 0)), l.some((c) => c.field > 0)) {
      ...
      t.state.field(vo, !1) === void 0 && f.push(Fe.appendConfig.of([vo, n$, s$, dm]));
    }
...
const s$ = /* @__PURE__ */ me.domEventHandlers({
  mousedown(i, e) {
...
function vm(i, e) {
  ...
  return e.cursor(at.IncludeAnonymous).iterate((o) => {
    if (s)
      s = !1;
    else if (o.name) {
      let l = c$[o.name];
...
const v$ = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), b$ = /* @__PURE__ */ me.inputHandler.of((i, e, t, n, s) => {
...
function w$(i, e) {
  ...
  G(() => nt(O, "data-field", s())), te("click", m, d), A(i, p), kt();
}
...
function $$(i, e) {
  ...
  var a = ji(), h = De(a);
  {
    var c = (d) => {
      ...
      G(() => {
        Is(p, t()), p.disabled = r();
      }), te("input", p, (O) => s()(O.target.value)), A(d, p);
    }, f = (d) => {
      ...
      et(m, 1, () => u(o), Je, (M, T) => {
        var R = S$(), Z = w(R), z = {};
        G(() => {
          B(Z, `${u(T), b(() => u(T).displayName) ?? ""} (${u(T), b(() => u(T).service) ?? ""}${u(T), b(() => u(T).status !== "active" ? ` — ${u(T).status}` : "") ?? ""})`), z !== (z = (u(T), b(() => u(T).id))) && (R.value = (R.__value = (u(T), b(() => u(T).id))) ?? "");
        }), A(M, R);
      });
      var v;
      Xc(O);
      var Q = y(O, 2);
      {
        var x = (M) => {
          var T = k$(), R = w(T);
          G(() => B(R, `No ${n() ?? "integration" ?? ""} connections. Create one in Admin → Integration Connections.`)), A(M, T);
        };
        J(Q, (M) => {
      ...
      }), te("change", O, (M) => s()(M.target.value)), A(d, p);
    };
    J(h, (d) => {
      u(l) ? d(c) : d(f, -1);
    });
...
function M$(i, e) {
  var L, W;
  St(e, !1);
  const t = /* @__PURE__ */ q(), n = /* @__PURE__ */ q(), s = /* @__PURE__ */ q(), r = /* @__PURE__ */ q(), o = /* @__PURE__ */ q();
  let l = ze(e, "value", 8, void 0), a = ze(e, "onChange", 8), h = ze(e, "disabled", 8, !1);
  const c = "__custom";
  let f = /* @__PURE__ */ q([]), d = /* @__PURE__ */ q([]), p = /* @__PURE__ */ q(!1), O = /* @__PURE__ */ q(!1);
  const g = (W = (L = l()) == null ? void 0 : L.targets) == null ? void 0 : W[0];
  ...
  Un(async () => {
    try {
      ...
      if (!k.ok || !P.ok) throw new Error("load failed");
      S(f, await k.json());
      const _ = new Set(u(f).map((X) => X.provider));
      S(d, (await P.json()).filter((X) => _.has(X.service)));
      const $ = u(f).find((X) => {
        var C;
        return X.provider === ((C = u(d).find((ee) => ee.id === u(m))) == null ? void 0 : C.service);
      });
  ...
  function T(k) {
    ...
    const P = u(d).find((C) => C.id === k), _ = u(f).find((C) => C.provider === (P == null ? void 0 : P.service));
    u(v) === c || (_ == null ? void 0 : _.models.some((C) => C.id === u(v))) || S(v, ((X = (_ == null ? void 0 : _.models.find((C) => C.recommended)) ?? (_ == null ? void 0 : _.models[0])) == null ? void 0 : X.id) ?? c), x(P, u(v) === c ? u(Q).trim() : u(v));
  }
  qe(() => Xe(l()), () => {
    S(t, l() ?? null);
  }), qe(() => u(t), () => {
    ...
    var k, P, _, $, X;
    S(s, u(n) || (((k = u(t)) == null ? void 0 : k.strategy) ?? "priority") === "priority" && (((_ = (P = u(t)) == null ? void 0 : P.targets) == null ? void 0 : _.length) ?? 0) === 1 && (((X = ($ = u(t)) == null ? void 0 : $.triggers) == null ? void 0 : X.length) ?? 0) === 0);
  }), qe(() => u(s), () => {
    u(s) || S(O, !0);
  }), qe(() => (u(d), u(m)), () => {
    S(r, u(d).find((k) => k.id === u(m)));
  }), qe(() => (u(f), u(r)), () => {
    S(o, u(f).find((k) => {
      var P;
      return k.provider === ((P = u(r)) == null ? void 0 : P.service);
    }));
  }), Pi(), _t();
  var R = ji(), Z = De(R);
  {
    var z = (k) => {
      var P = P$(), _ = De(P), $ = y(_, 2);
      {
        var X = (C) => {
          var ee = _$();
          te("click", ee, () => {
      ...
      G(
        ...
        [
          () => (Xe(l()), b(() => JSON.stringify(l() ?? {}, null, 2)))
        ]
      ), te("blur", _, (C) => {
        try {
          a()(JSON.parse(C.currentTarget.value));
        } catch {
        }
      }), A(k, P);
    }, D = (k) => {
      ...
      et(X, 1, () => u(d), Je, (se, de) => {
        ...
        G(
          (Ce) => {
            B(ae, `${u(de), b(() => u(de).displayName) ?? ""} (${Ce ?? ""}${u(de), b(() => u(de).status !== "active" ? ` — ${u(de).status}` : "") ?? ""})`), we !== (we = (u(de), b(() => u(de).id))) && (be.value = (be.__value = (u(de), b(() => u(de).id))) ?? "");
          },
          [
            () => (u(f), u(de), b(() => {
              var Ce;
              return ((Ce = u(f).find((V) => V.provider === u(de).service)) == null ? void 0 : Ce.displayName) ?? u(de).service;
            }))
          ]
        ), A(se, be);
      });
        ...
        var ie = (se) => {
          ...
          et(
            ...
            (oe, ce) => {
              var Oe = C$(), pe = w(Oe), $e = {};
              G(() => {
                B(pe, `${u(ce), b(() => u(ce).label) ?? ""}${u(ce), b(() => u(ce).recommended ? " (recommended)" : "") ?? ""}`), $e !== ($e = (u(ce), b(() => u(ce).id))) && (Oe.value = (Oe.__value = (u(ce), b(() => u(ce).id))) ?? "");
              }), A(oe, Oe);
            }
          );
          var we = y(ae);
          ...
          var Ce = y(be, 2);
          {
            var V = (oe) => {
              var ce = Z$();
              G(() => ce.disabled = h()), It(ce, () => u(Q), (Oe) => S(Q, Oe)), te("blur", ce, M), A(oe, ce);
            };
            J(Ce, (oe) => {
              u(v) === c && oe(V);
            });
          }
          G(() => be.disabled = h()), wl(be, () => u(v), (oe) => S(v, oe)), te("change", be, M), A(se, de);
        };
        J(ee, (se) => {
          u(o) && se(ie);
        });
      ...
      var H = y(ee, 2);
      {
        ...
        J(H, (se) => {
          u(d), b(() => u(d).length === 0) && se(U);
        });
      }
      var le = y(H, 2);
      G(() => {
        _.disabled = h(), C !== (C = u(m)) && (_.value = (_.__value = u(m)) ?? "", ra(_, u(m)));
      }), te("change", _, (se) => T(se.currentTarget.value)), te("click", le, () => {
        S(O, !0);
      }), A(k, P);
    };
    J(Z, (k) => {
...
function B$(i, e) {
  St(e, !1);
  const t = () => ct(Fr, "$nodeTypes", s), n = () => ct(ot, "$graph", s), [s, r] = $n(), o = /* @__PURE__ */ q(), l = /* @__PURE__ */ q(), a = /* @__PURE__ */ q();
  ...
  function O(_) {
    var C, ee;
    const $ = t().find((ie) => ie.type === _.type), X = (ee = (C = $ == null ? void 0 : $.schema) == null ? void 0 : C.output) == null ? void 0 : ee.properties;
  ...
  async function g(_, $) {
    try {
      ...
      S(p, {
        ...u(p),
        [_]: C.error ? `Error: ${C.error}` : JSON.stringify(C.result)
      });
    } catch {
      S(p, { ...u(p), [_]: "Request failed" });
    }
  }
  function m(_, $) {
    ot.update((X) => ({
  ...
  function Q() {
    ot.update((_) => {
      ...
      return delete $[h().id], {
        ..._,
        nodes: $,
        edges: _.edges.filter((X) => X.from !== h().id && X.to !== h().id)
      };
    }), Wn.set(null);
  }
  function x(_) {
  ...
  qe(() => (t(), Xe(h())), () => {
    S(o, t().find((_) => _.type === h().type));
  }), qe(() => u(o), () => {
    var _, $, X;
    S(l, ((X = ($ = (_ = u(o)) == null ? void 0 : _.schema) == null ? void 0 : $.config) == null ? void 0 : X.properties) ?? {});
  }), qe(() => (n(), Xe(h())), () => {
    S(a, Object.values(n().nodes).filter((_) => n().edges.some(($) => $.to === h().id && $.from === _.id)));
  }), qe(() => Xe(h()), () => {
    var _;
    (_ = h()) != null && _.id && (S(d, null), S(p, {}), S(f, null));
  }), Pi(), _t();
  var T = V$(), R = w(T), Z = w(R), z = w(Z), D = y(Z, 2), L = y(R, 2), W = y(w(L), 2), k = y(L, 2);
  et(
    k,
    1,
    ...
    Je,
    (_, $) => {
      var X = /* @__PURE__ */ ws(() => Bm(u($), 2));
      let C = () => u(X)[0], ee = () => u(X)[1];
      var ie = q$(), H = w(ie), U = w(H), le = y(H, 2);
      {
        var se = (V) => {
          {
            let oe = /* @__PURE__ */ wt(() => (C(), b(() => String(x(C()) ?? ""))));
            $$(V, {
              get value() {
                return u(oe);
              },
          ...
          var oe = ji(), ce = De(oe);
          r0(ce, () => (Xe(h()), b(() => h().id)), (Oe) => {
            {
              let pe = /* @__PURE__ */ wt(() => (C(), b(() => x(C()))));
              M$(Oe, {
                get value() {
                  return u(pe);
                },
          ...
          G(
            (ce) => {
              Is(oe, ce), oe.disabled = c();
            },
            [
              () => (C(), b(() => JSON.stringify(x(C()) ?? {}, null, 2)))
            ]
          ), te("blur", oe, (ce) => {
            try {
              m(C(), JSON.parse(ce.target.value));
            } catch {
            }
          }), A(V, oe);
        }, ae = (V) => {
          ...
          G(
            ...
            [
              () => (C(), b(() => Array.isArray(x(C())) ? x(C()).join(", ") : String(x(C()) ?? "")))
            ]
          ), te("input", oe, (ce) => m(C(), ce.target.value.split(",").map((Oe) => Oe.trim()).filter(Boolean))), A(V, oe);
        }, we = (V) => {
          var oe = L$();
          G(
            (ce) => {
              O0(oe, ce), oe.disabled = c();
            },
            [() => (C(), b(() => !!x(C())))]
          ), te("change", oe, (ce) => m(C(), ce.target.checked)), A(V, oe);
        }, Ce = (V) => {
          var oe = ji(), ce = De(oe);
          {
            var Oe = ($e) => {
              var He = D$(), je = De(He);
              {
                let Te = /* @__PURE__ */ wt(() => (C(), b(() => String(x(C()) ?? "")))), N = /* @__PURE__ */ wt(() => (u(a), b(() => u(a).flatMap(O))));
                w$(je, {
                  get value() {
                    return u(Te);
                  },
              ...
              var He = W$(), je = De(He), it = w(je), Be = y(it, 2);
              {
                var mt = (ne) => {
                  var fe = z$();
                  G(() => fe.disabled = c()), te("click", fe, () => {
                    S(f, u(f) === C() ? null : C());
                  }), A(ne, fe);
                };
                J(Be, (ne) => {
                  u(a), b(() => u(a).length > 0) && ne(mt);
                });
              }
              var Te = y(Be, 2), N = y(je, 2);
              {
                var j = (ne) => {
                  var fe = Y$(), Re = y(w(fe), 2);
                  et(Re, 1, () => u(a), Je, (Ge, Se) => {
                    var K = ji(), ue = De(K);
                    et(
                      ue,
                      1,
                      ...
                      Je,
                      (ye, Ye) => {
                        var Me = N$(), _e = w(Me), Ue = w(_e), xe = y(_e, 2), Pe = w(xe);
                        G(() => {
                          B(Ue, (u(Se), b(() => u(Se).label ?? u(Se).id))), B(Pe, `$.${u(Ye) ?? ""}`);
                        }), te("click", Me, () => M(C(), u(Se).id, u(Ye))), A(ye, Me);
                      }
                    ), A(Ge, K);
                  }), A(ne, fe);
                };
                J(N, (ne) => {
                  u(f), C(), u(a), b(() => u(f) === C() && u(a).length > 0) && ne(j);
                });
              }
              G(
                (ne) => {
                  Is(it, ne), it.disabled = c(), Te.disabled = c();
                },
                [
                  () => (C(), b(() => String(x(C()) ?? "")))
                ]
              ), te("input", it, (ne) => m(C(), ne.target.value)), te("click", Te, () => {
                S(d, C()), S(f, null);
              }), A($e, He);
            };
            J(ce, ($e) => {
        ...
        J(le, (V) => {
          ee(), b(() => ee().format === "connection") ? V(se) : (ee(), b(() => ee().format === "model-router") ? V(de, 1) : (ee(), b(() => ee().type === "object") ? V(be, 2) : (ee(), b(() => ee().type === "array") ? V(ae, 3) : (ee(), b(() => ee().type === "boolean") ? V(we, 4) : V(Ce, -1)))));
        });
      }
      G(() => B(U, (ee(), C(), b(() => ee().description ?? C())))), A(_, ie);
    }
  );
  var P = y(k, 2);
  G(() => {
    B(z, `Node: ${Xe(h()), b(() => h().type) ?? ""}`), Is(W, (Xe(h()), b(() => h().label ?? ""))), W.disabled = c(), P.disabled = c();
  }), te("click", D, () => Wn.set(null)), te("input", W, (_) => v(_.target.value)), te("click", P, Q), A(i, T), kt(), r();
}
...
function f_(i, e) {
  St(e, !1);
  const t = () => ct(ot, "$graph", r), n = () => ct(Rs, "$agentConfig", r), s = () => ct(fl, "$agent", r), [r, o] = $n();
  let l = ze(e, "agentId", 8), a = ze(e, "readonly", 8, !1), h = /* @__PURE__ */ q(!1), c = /* @__PURE__ */ q(""), f = /* @__PURE__ */ q(!1), d = /* @__PURE__ */ q(""), p = /* @__PURE__ */ q(!1), O = /* @__PURE__ */ q(""), g = /* @__PURE__ */ q(!1), m = /* @__PURE__ */ q(""), v = /* @__PURE__ */ q([]), Q = /* @__PURE__ */ q([]), x = /* @__PURE__ */ q(""), M = /* @__PURE__ */ q(""), T = /* @__PURE__ */ q(""), R = /* @__PURE__ */ q(""), Z = /* @__PURE__ */ q(!1);
  Un(async () => {
    try {
      const [K, ue] = await Promise.all([
        fetch("/api/integrations"),
        fetch("/api/integrations/triggers")
      ]);
      if (K.ok) {
        const ye = await K.json();
        S(v, ye.filter((Ye) => Ye.hasTrigger));
      }
      if (ue.ok) {
        const ye = await ue.json();
        S(Q, ye.filter((Ye) => Ye.agentId === l()));
      }
    } catch {
    }
  });
  async function z() {
    ...
    try {
      ...
      const ue = await K.json();
      S(Q, [...u(Q), ue]), S(T, ""), S(M, ""), S(R, "✓ Trigger registered");
    } catch (K) {
      S(R, "✗ " + (K instanceof Error ? K.message : "Error"));
    } finally {
      S(Z, !1);
    }
  }
  async function D(K) {
    try {
      const ue = await fetch(`/api/integrations/triggers/${K}`, { method: "DELETE" });
      (ue.ok || ue.status === 204) && S(Q, u(Q).filter((ye) => ye.id !== K));
    } catch {
    }
  }
  async function L() {
    ...
    try {
      ...
      S(c, "✓ Published");
      const ye = await fetch(`/api/agents/${l()}`);
      ye.ok && fl.set(await ye.json());
    } catch (K) {
      S(c, "✗ " + (K instanceof Error ? K.message : "Error"));
    } finally {
      S(h, !1);
    }
  }
  async function W() {
    ...
    try {
      ...
      S(O, "✗ " + (K instanceof Error ? K.message : "Error"));
    } finally {
      S(p, !1);
    }
  }
  async function k() {
    ...
    try {
      ...
      fl.set(await K.json()), S(m, "✓ Reverted to draft");
    } catch (K) {
      S(m, "✗ " + (K instanceof Error ? K.message : "Error"));
    } finally {
      S(g, !1);
    }
  }
  async function P() {
    S(f, !0), S(d, "");
    try {
      const K = { type: n().triggerType };
      if (n().triggerType === "cron" && (K.expression = n().cronExpression), !(await fetch(`/api/agents/${l()}/config`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ triggerConfig: K })
      })).ok) throw new Error("Save failed");
      if (S(d, "✓ Saved"), n().triggerType === "webhook") {
        const ye = await fetch(`/api/agents/${l()}/config`);
        if (ye.ok) {
          const Ye = await ye.json();
          Rs.update((Me) => {
            var _e;
      ...
      S(d, "✗ " + (K instanceof Error ? K.message : "Error"));
    } finally {
      S(f, !1);
    }
  }
  _t();
  var _ = c_(), $ = De(_), X = y(w($), 2);
  {
    var C = (K) => {
      var ue = G$(), ye = De(ue), Ye = w(ye), Me = y(ye, 2), _e = w(Me);
      G(() => {
        B(Ye, (s(), b(() => s().name))), Jt(Me, 1, `agent-status status-${s(), b(() => s().status) ?? ""}`, "svelte-5tjmbm"), B(_e, (s(), b(() => s().status)));
      }), A(K, ue);
    };
    J(X, (K) => {
      s() && K(C);
  ...
  var ee = y(X, 2), ie = w(ee), H = w(ie), U = y(ie, 2), le = w(U), se = y(ee, 2);
  {
    var de = (K) => {
      var ue = U$(), ye = w(ue);
      G(() => B(ye, u(O))), A(K, ue);
  ...
  {
    var Ce = (K) => {
      var ue = K$(), ye = De(ue), Ye = w(ye), Me = y(ye, 2);
      {
        var _e = (Ue) => {
          var xe = H$(), Pe = w(xe);
          G(() => B(Pe, u(m))), A(Ue, xe);
      ...
      G(() => {
        ye.disabled = u(g), B(Ye, u(g) ? "Reverting…" : "Revert to Draft");
      }), te("click", ye, k), A(K, ue);
    };
    J(we, (K) => {
      s(), Xe(a()), b(() => {
        var ue;
        return ((ue = s()) == null ? void 0 : ue.status) === "active" && !a();
      }) && K(Ce);
    });
  }
  var V = y($, 2), oe = y(w(V), 2), ce = y(w(oe), 2), Oe = w(ce);
  Oe.value = Oe.__value = "rest";
  var pe = y(Oe);
  pe.value = pe.__value = "cron";
  var $e = y(pe);
    ...
    var it = (K) => {
      var ue = s_(), ye = De(ue);
      {
        var Ye = (lt) => {
          ...
          et(Yi, 1, () => u(Q), Je, (Cr, Vt) => {
            var fn = e_(), un = w(fn), Cs = w(un), Sm = w(Cs), Qf = y(Cs, 2);
            {
              var km = (ka) => {
                var $f = J$(), Pm = w($f);
                G(() => B(Pm, (u(Vt), b(() => u(Vt).eventFilter)))), A(ka, $f);
              };
              J(Qf, (ka) => {
            ...
            G(() => {
              B(Sm, (u(Vt), b(() => u(Vt).service))), B($m, (u(Vt), b(() => u(Vt).url)));
            }), te("click", _m, () => D(u(Vt).id)), A(Cr, fn);
          }), A(lt, Xt);
        };
        J(ye, (lt) => {
          u(Q), b(() => u(Q).length > 0) && lt(Ye);
        });
      }
      var Me = y(ye, 2), _e = y(w(Me), 2), Ue = w(_e);
      Ue.value = Ue.__value = "";
      var xe = y(Ue);
      et(xe, 1, () => u(v), Je, (lt, Xt) => {
        var Yi = i_(), Cr = w(Yi), Vt = {};
        G(() => {
          B(Cr, (u(Xt), b(() => u(Xt).displayName))), Vt !== (Vt = (u(Xt), b(() => u(Xt).service))) && (Yi.value = (Yi.__value = (u(Xt), b(() => u(Xt).service))) ?? "");
        }), A(lt, Yi);
      });
      var Pe = y(Me, 2), Wt = y(w(Pe), 2), pt = y(Pe, 2), Pn = y(w(pt), 2), Mt = y(pt, 2), qt = w(Mt), Hn = y(Mt, 2);
      {
        var Tr = (lt) => {
          var Xt = n_(), Yi = w(Xt);
          G(() => B(Yi, u(R))), A(lt, Xt);
      ...
      G(() => {
        Mt.disabled = u(Z) || !u(x) || !u(T), B(qt, u(Z) ? "Registering…" : "Register Trigger");
      }), wl(_e, () => u(x), (lt) => S(x, lt)), It(Wt, () => u(M), (lt) => S(M, lt)), It(Pn, () => u(T), (lt) => S(T, lt)), te("click", Mt, z), A(K, ue);
    };
    J(je, (K) => {
      n(), b(() => n().triggerType === "integration") && K(it);
    });
  }
  var Be = y(je, 2);
  {
    var mt = (K) => {
      var ue = r_(), ye = y(w(ue), 2);
      It(ye, () => n().cronExpression, (Ye) => $a(Rs, b(n).cronExpression = Ye, b(n))), A(K, ue);
    };
    J(Be, (K) => {
      n(), b(() => n().triggerType === "cron") && K(mt);
    });
  }
  var Te = y(Be, 2);
  {
    var N = (K) => {
      var ue = a_(), ye = y(w(ue), 2);
      {
        var Ye = (_e) => {
          var Ue = o_(), xe = w(Ue), Pe = w(xe);
          G(() => B(Pe, (n(), b(() => n().webhookUrl)))), A(_e, Ue);
        }, Me = (_e) => {
          var Ue = l_();
          A(_e, Ue);
        };
    ...
    J(Te, (K) => {
      n(), b(() => n().triggerType === "webhook") && K(N);
    });
  }
  var j = y(Te, 2), ne = y(w(j), 2), fe = y(j, 2), Re = w(fe), Ge = y(fe, 2);
  {
    var Se = (K) => {
      var ue = h_(), ye = w(ue);
      G(() => B(ye, u(d))), A(K, ue);
  ...
  G(() => {
    ie.disabled = u(p) || a(), B(H, u(p) ? "Saving…" : "Save Draft"), U.disabled = u(h) || a(), B(le, u(h) ? "Publishing…" : "Publish"), fe.disabled = u(f), B(Re, u(f) ? "Saving…" : "Save");
  }), te("click", ie, W), te("click", U, L), wl(ce, () => n().triggerType, (K) => $a(Rs, b(n).triggerType = K, b(n))), It(ne, () => n().description, (K) => $a(Rs, b(n).description = K, b(n))), te("click", fe, P), A(i, _), kt(), o();
}
const ri = Qn({
  runId: null,
  status: "idle",
...
function Q_(i, e) {
  St(e, !1);
  const t = () => ct(ri, "$runState", n), [n, s] = $n();
  ...
  async function d(D) {
    try {
      const L = await fetch(`/api/telemetry/trajectory/${D}`);
      if (!L.ok) return;
  ...
  async function O() {
    ...
    try {
      ...
      if (!k.ok) {
        ...
        throw new Error(((W = _ == null ? void 0 : _.error) == null ? void 0 : W.message) ?? `HTTP ${k.status}`);
      }
      L = (await k.json()).runId;
    } catch (k) {
      ri.set({
        runId: null,
        status: "failed",
    ...
    ri.update((k) => ({ ...k, runId: L })), a = new EventSource(`/api/agents/${r()}/runs/${L}/stream`), a.addEventListener("node.started", (k) => {
      const P = JSON.parse(k.data);
      ri.update((_) => ({
        ..._,
        steps: [
          ..._.steps.filter(($) => $.nodeId !== P.nodeId),
          {
            id: P.nodeId,
            nodeId: P.nodeId,
            nodeType: P.nodeType,
      ...
      ri.update((_) => ({
        ..._,
        steps: _.steps.map(($) => $.nodeId === P.nodeId ? {
          ...$,
          status: "complete",
      ...
      const P = JSON.parse(k.data);
      ri.update((_) => ({ ..._, status: "completed", output: P.output })), p(), d(L);
    }), a.addEventListener("run.failed", (k) => {
      const P = JSON.parse(k.data);
      ri.update((_) => ({ ..._, status: "failed", error: P.error.message })), p();
  ...
  _t();
  var g = k_(), m = y(w(g), 2), v = y(w(m), 2), Q = y(m, 2), x = w(Q), M = w(x), T = y(x, 2);
  {
    var R = (D) => {
      var L = u_();
      te("click", L, p), A(D, L);
  ...
  {
    var z = (D) => {
      var L = S_(), W = De(L), k = w(W), P = w(k), _ = y(k, 2);
      {
        var $ = (H) => {
          var U = d_(), le = w(U);
          G((se) => B(le, se), [
      ...
      {
        var ie = (H) => {
          var U = x_(), le = De(U), se = w(le), de = y(le, 2);
          et(de, 1, () => (t(), b(() => t().steps)), Je, (be, ae) => {
            var we = w_(), Ce = De(we), V = w(Ce), oe = w(V), ce = y(V, 2), Oe = w(ce), pe = y(ce, 2);
            {
              var $e = (Be) => {
                const mt = /* @__PURE__ */ wt(() => (u(c), u(ae), b(() => u(c).filter((ne) => ne.stepId === u(ae).stepId))));
                var Te = ji(), N = De(Te);
                {
                  var j = (ne) => {
                    var fe = O_(), Re = w(fe);
                    G(() => B(Re, `▶ Trajectory (${Xe(u(mt)), b(() => u(mt).length) ?? ""} steps)`)), te("click", fe, () => S(f, u(f) === u(ae).nodeId ? null : u(ae).nodeId)), A(ne, fe);
                  };
                  J(N, (ne) => {
                    Xe(u(mt)), b(() => u(mt).length > 0) && ne(j);
                  });
                }
                A(Be, Te);
              }, He = /* @__PURE__ */ ws(() => (u(ae), t(), b(() => h.has(u(ae).nodeType) && t().status !== "running")));
              J(pe, (Be) => {
                u(He) && Be($e);
              });
            }
            ...
            {
              var it = (Be) => {
                const mt = /* @__PURE__ */ wt(() => (u(c), u(ae), b(() => u(c).filter((N) => N.stepId === u(ae).stepId))));
                var Te = y_();
                et(Te, 5, () => u(mt), Je, (N, j) => {
                  var ne = b_(), fe = w(ne), Re = w(fe), Ge = y(fe, 2);
                  {
                    var Se = (Me) => {
                      var _e = g_(), Ue = y(w(_e));
                      G(() => B(Ue, ` ${u(j), b(() => u(j).thought) ?? ""}`)), A(Me, _e);
                    };
                    J(Ge, (Me) => {
                      u(j), b(() => u(j).thought) && Me(Se);
                    });
                  }
                  var K = y(Ge, 2);
                  {
                    var ue = (Me) => {
                      var _e = m_(), Ue = y(w(_e));
                      G(() => B(Ue, ` ${u(j), b(() => u(j).action) ?? ""}`)), A(Me, _e);
                    };
                    J(K, (Me) => {
                      u(j), b(() => u(j).action) && Me(ue);
                    });
                  }
                  var ye = y(K, 2);
                  {
                    var Ye = (Me) => {
                      var _e = v_(), Ue = y(w(_e));
                      G(() => B(Ue, ` ${u(j), b(() => u(j).observation) ?? ""}`)), A(Me, _e);
                    };
                    J(ye, (Me) => {
                      u(j), b(() => u(j).observation) && Me(Ye);
                    });
                  }
                  G(() => B(Re, `Iter ${u(j), b(() => u(j).iteration) ?? ""}`)), A(N, ne);
                }), A(Be, Te);
              };
              J(je, (Be) => {
                u(f), u(ae), b(() => u(f) === u(ae).nodeId) && Be(it);
              });
            }
            G(() => {
              Jt(Ce, 1, `step step-${u(ae), b(() => u(ae).status) ?? ""}`, "svelte-gqobos"), B(oe, (u(ae), b(() => u(ae).nodeType))), Jt(ce, 1, `step-badge badge-${u(ae), b(() => u(ae).status) ?? ""}`, "svelte-gqobos"), B(Oe, (u(ae), b(() => u(ae).status)));
            }), A(be, we);
          }), G(() => B(se, `Steps (${t(), b(() => t().steps.length) ?? ""})`)), A(H, U);
        };
        J(ee, (H) => {
          t(), b(() => t().steps.length > 0) && H(ie);
        });
      }
      G(
        (H) => {
          Jt(W, 1, `run-result status-${t(), b(() => t().status) ?? ""}`, "svelte-gqobos"), B(P, H);
        },
        [
  ...
  G(() => {
    x.disabled = u(l), B(M, u(l) ? "Running…" : "▶ Run");
  }), It(v, () => u(o), (D) => S(o, D)), te("click", x, O), A(i, g), kt(), s();
}
...
function E_(i, e) {
  St(e, !1);
  const t = () => ct(ot, "$graph", r), n = () => ct(Fr, "$nodeTypes", r), s = () => ct(Wc, "$connections", r), [r, o] = $n(), l = /* @__PURE__ */ q(), a = /* @__PURE__ */ q(), h = /* @__PURE__ */ q(), c = /* @__PURE__ */ q();
  let f = /* @__PURE__ */ q(!1);
  Un(() => {
    iO();
  });
  function d(x) {
    ...
    for (const D of x.edges) {
      const L = T.get(D.from) ?? [];
      L.push(D.to), T.set(D.from, L);
    }
    const R = /* @__PURE__ */ new Map();
    function Z(D) {
      var L;
      R.set(D, "visiting");
      for (const W of T.get(D) ?? [])
        if (R.get(W) === "visiting") {
          const k = x.nodes[D];
          (k == null ? void 0 : k.type) !== "core:loop" && M.push({
            severity: "error",
            message: `Cycle edge from "${(k == null ? void 0 : k.label) ?? D}" to "${((L = x.nodes[W]) == null ? void 0 : L.label) ?? W}" is only legal when the source is a core:loop node — the engine silently skips it otherwise`,
            nodeId: D
          });
        } else R.has(W) || Z(W);
      R.set(D, "done");
    }
    const z = x.entry ?? Object.keys(x.nodes)[0];
    return z && x.nodes[z] && Z(z), M;
  }
  function p(x, M, T) {
    var z, D;
    const R = [], Z = new Set(T.map((L) => L.id));
    for (const L of Object.values(x.nodes)) {
      const W = M.find((P) => P.type === L.type), k = (D = (z = W == null ? void 0 : W.schema) == null ? void 0 : z.config) == null ? void 0 : D.properties;
      if (k)
        for (const [P, _] of Object.entries(k)) {
          if (_.format !== "connection") continue;
          const $ = L.config[P];
          (!$ || !Z.has(String($))) && R.push({
            severity: "error",
            message: `Node "${L.label ?? L.id}" is missing a valid ${_.service ?? "integration"} connection for "${P}"`,
            nodeId: L.id
          });
        }
    }
  ...
  function O(x, M, T) {
    const R = [], Z = Object.values(x.nodes), z = x.edges, D = new Set(M.map(($) => $.type));
    if (Z.length === 0)
      return R.push({
        severity: "error",
    ...
    for (const $ of Z)
      D.size > 0 && !D.has($.type) && R.push({
        severity: "error",
        message: `Node "${$.label ?? $.id}" has unknown type "${$.type}"`,
        nodeId: $.id
      });
    const L = x.entry ?? Object.keys(x.nodes)[0];
    x.nodes[L] || R.push({ severity: "error", message: "No entry node defined" });
    const W = /* @__PURE__ */ new Set(), k = [L];
    for (; k.length > 0; ) {
      const $ = k.shift();
      if (!W.has($)) {
        W.add($);
        for (const X of z)
          X.from === $ && !W.has(X.to) && k.push(X.to);
      }
    }
    for (const $ of Z)
      W.has($.id) || R.push({
    ...
    for (const $ of Z) {
      const X = z.filter((ie) => ie.from === $.id);
      if (X.length === 0) continue;
      const C = X.some((ie) => ie.type === "conditional"), ee = X.some((ie) => ie.type === "fallback" || ie.type === "unconditional");
      C && !ee && R.push({
        severity: "warning",
    ...
    const P = /* @__PURE__ */ new Set(["core:end", "core:stop"]);
    for (const $ of Z) {
      if (P.has($.type)) continue;
      z.filter((C) => C.from === $.id).length === 0 && R.push({
        severity: "warning",
  ...
  qe(() => (t(), n(), s()), () => {
    ...
    S(a, u(l).filter((x) => x.severity === "error"));
  }), qe(() => u(l), () => {
    S(h, u(l).filter((x) => x.severity === "warning"));
  }), qe(() => (u(a), u(h), u(f)), () => {
    S(c, u(a).length === 0 && (u(h).length === 0 || u(f)));
  }), Pi(), _t();
  var m = ji(), v = De(m);
  {
    var Q = (x) => {
      var M = Z_(), T = w(M), R = y(w(T), 2);
      {
        var Z = ($) => {
          var X = $_(), C = w(X);
          G(() => B(C, `${u(a), b(() => u(a).length) ?? ""} error${u(a), b(() => u(a).length !== 1 ? "s" : "") ?? ""}`)), A($, X);
        };
        J(R, ($) => {
          u(a), b(() => u(a).length > 0) && $(Z);
        });
      }
      var z = y(R, 2);
      {
        var D = ($) => {
          var X = __(), C = w(X);
          G(() => B(C, `${u(h), b(() => u(h).length) ?? ""} warning${u(h), b(() => u(h).length !== 1 ? "s" : "") ?? ""}`)), A($, X);
        };
        J(z, ($) => {
      ...
      var L = y(T, 2), W = w(L);
      et(W, 1, () => u(a), Je, ($, X) => {
        var C = P_(), ee = y(w(C), 2), ie = w(ee);
        G(() => B(ie, (u(X), b(() => u(X).message)))), te("click", C, () => g(u(X).nodeId)), te("keydown", C, (H) => H.key === "Enter" && g(u(X).nodeId)), A($, C);
      });
      var k = y(W, 2);
      et(k, 1, () => u(h), Je, ($, X) => {
        var C = T_(), ee = y(w(C), 2), ie = w(ee);
        G(() => B(ie, (u(X), b(() => u(X).message)))), te("click", C, () => g(u(X).nodeId)), te("keydown", C, (H) => H.key === "Enter" && g(u(X).nodeId)), A($, C);
      });
      var P = y(L, 2);
      {
        var _ = ($) => {
          var X = C_(), C = w(X);
          _p(C, () => u(f), (ee) => S(f, ee)), A($, X);
        };
        J(P, ($) => {
          u(a), u(h), b(() => u(a).length === 0 && u(h).length > 0) && $(_);
        });
      }
      A(x, M);
    };
...
function Y_(i, e) {
  St(e, !1);
  const t = () => ct(Wn, "$selectedNode", s), n = () => ct(ot, "$graph", s), [s, r] = $n(), o = /* @__PURE__ */ q(), l = /* @__PURE__ */ q(), a = /* @__PURE__ */ q(), h = /* @__PURE__ */ q(), c = /* @__PURE__ */ q(), f = /* @__PURE__ */ new Set(["core:tool", "core:mcp-client"]), d = /* @__PURE__ */ new Set(["core:tool-call", "core:react"]);
  qe(() => t(), () => {
    var M;
    S(o, ((M = t()) == null ? void 0 : M.id) ?? null);
  }), qe(() => t(), () => {
    var M;
    S(l, ((M = t()) == null ? void 0 : M.type) ?? null);
  }), qe(() => (u(o), u(l), n()), () => {
    S(a, u(o) && d.has(u(l) ?? "") ? (n().toolEdges ?? []).filter((M) => M.to === u(o)).map((M) => {
      var R, Z;
      const T = n().nodes[M.from];
      return {
        edge: M,
        node: T,
        name: T ? String(((R = T.config) == null ? void 0 : R.name) ?? T.type) : M.from,
    ...
    var M;
    S(h, u(o) && f.has(u(l) ?? "") ? (M = t()) == null ? void 0 : M.config : null);
  }), qe(() => (u(o), u(l), n()), () => {
    S(c, u(o) && f.has(u(l) ?? "") ? (n().toolEdges ?? []).filter((M) => M.from === u(o)).map((M) => n().nodes[M.to]).filter(Boolean) : []);
  }), Pi(), _t();
  var p = N_(), O = y(w(p), 2);
  {
    var g = (M) => {
      var T = ji(), R = De(T);
      {
        var Z = (D) => {
          ...
          var L = X_();
          et(L, 5, () => u(a), Je, (W, k) => {
            let P = () => u(k).name, _ = () => u(k).source, $ = () => u(k).description;
            var X = M_(), C = w(X), ee = w(C), ie = y(C, 2), H = w(ie), U = y(ie, 2);
            {
              var le = (se) => {
                var de = R_(), be = w(de);
                G((ae) => B(be, ae), [
...
function U_(i, e) {
  ...
  let s = /* @__PURE__ */ q({});
  function r() {
    S(s, Object.fromEntries(t().patches.map((D, L) => [L, !0])));
  }
  function o() {
    S(s, Object.fromEntries(t().patches.map((D, L) => [L, !1])));
  }
  function l() {
    const D = t().patches.filter((L, W) => u(s)[W]);
    n("apply", { ...t(), patches: D });
  }
  function a() {
    n("reject");
  ...
  var f = G_(), d = w(f), p = w(d), O = w(p), g = y(p, 2), m = w(g), v = y(d, 2);
  {
    var Q = (D) => {
      var L = W_(), W = w(L);
      G(() => B(W, (Xe(t()), b(() => t().rationale)))), A(D, L);
    };
    J(v, (D) => {
      Xe(t()), b(() => t().rationale) && D(Q);
    });
  }
  var x = y(v, 2);
  et(
    ...
    Je,
    (D, L, W) => {
      var k = B_(), P = w(k), _ = y(P, 2), $ = w(_), X = y(_, 2);
      {
        var C = (U) => {
          var le = q_(), se = w(le);
          G(() => B(se, (u(L), b(() => u(L).target)))), A(U, le);
        };
        J(X, (U) => {
          u(L), b(() => u(L).target) && U(C);
        });
      }
      var ee = y(X, 2);
      {
        var ie = (U) => {
          var le = V_(), se = w(le);
          G((de) => B(se, `${de ?? ""}…`), [
            () => (u(L), b(() => JSON.stringify(u(L).data).slice(0, 60)))
          ]), A(U, le);
        }, H = /* @__PURE__ */ ws(() => (u(L), b(() => u(L).data && Object.keys(u(L).data).length > 0)));
        J(ee, (U) => {
          u(H) && U(ie);
        });
      }
      G((U) => B($, U), [
        () => (u(L), b(() => c(u(L).op)))
      ]), _p(P, () => u(s)[W], (U) => Zn(s, u(s)[W] = U)), A(D, k);
    }
  );
  var M = y(x, 2), T = w(M), R = y(T, 2), Z = y(R, 4), z = y(Z, 2);
  G(() => {
    $p(p, `color: ${Xe(t()), b(() => h[t().complexity]) ?? ""}`), B(O, (Xe(t()), b(() => t().complexity))), B(m, (Xe(t()), b(() => t().description)));
  }), te("click", T, r), te("click", R, o), te("click", Z, a), te("click", z, l), A(i, f), kt();
}
...
function fP(i, e) {
  St(e, !1);
  const t = () => ct(ot, "$graph", o), n = () => ct(Wn, "$selectedNode", o), s = () => ct(ri, "$runState", o), r = () => ct(Po, "$canUndoCaalChange", o), [o, l] = $n(), a = /* @__PURE__ */ q();
  ...
  async function T(V, oe) {
    if (!V.trim() || u(p)) return;
    const ce = { role: "user", content: V, timestamp: Date.now() };
    S(f, [...u(f), ce]), S(d, ""), S(p, !0), W();
    try {
      const Oe = {
        ...t(),
      ...
      }, $e = await fetch("/api/caal/invoke", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(pe)
      }), He = await $e.json();
      if (He.sessionId && S(g, He.sessionId), He.code === "CAAL_STILL_RUNNING") {
        S(f, [
          ...u(f),
          {
            role: "assistant",
      ...
      if (!$e.ok) throw new Error(`Caal invoke failed: ${$e.status}`);
      const je = He.output ?? {}, it = {
        role: "assistant",
        content: je.content ?? "",
        nodeReferences: je.nodeReferences ?? [],
        proposal: je.proposal,
        canvasHighlight: je.canvasHighlight,
        canvasFocus: je.canvasFocus,
        timestamp: Date.now()
      };
      S(f, [...u(f), it]), je.proposal && S(O, je.proposal), je.canvasHighlight && Z(je.canvasHighlight), je.canvasFocus && z(je.canvasFocus);
    } catch (Oe) {
      const pe = {
        role: "assistant",
  ...
  function R(V) {
    const oe = V.toLowerCase();
    return /\b(add|create|remove|delete|update|change|modify|rename|move|connect|disconnect)\b/.test(oe) ? "modify" : /\b(suggest|improve|optimize|better|recommend|enhance)\b/.test(oe) ? "suggest" : "question";
  }
  function Z(V) {
    window.dispatchEvent(new CustomEvent("caal:canvas-highlight", { detail: V }));
  }
  function z(V) {
    window.dispatchEvent(new CustomEvent("caal:canvas-focus", { detail: V }));
  }
  function D(V) {
    window.dispatchEvent(new CustomEvent("caal:canvas-focus", { detail: { nodeId: V, zoom: 1.5 } })), window.dispatchEvent(new CustomEvent("caal:canvas-highlight", {
      detail: { nodeIds: [V], color: "#F59E0B", durationMs: 2e3 }
    }));
  }
  function L(V) {
    const oe = [], ce = /\[\[([^\]]+)\]\]/g;
    let Oe = 0, pe;
    for (; (pe = ce.exec(V)) !== null; )
      pe.index > Oe && oe.push({ type: "text", value: V.slice(Oe, pe.index) }), oe.push({ type: "chip", value: pe[1] }), Oe = pe.index + pe[0].length;
    return Oe < V.length && oe.push({ type: "text", value: V.slice(Oe) }), oe;
  }
  function W() {
  ...
  function k(V) {
    V.key === "Enter" && !V.shiftKey && (V.preventDefault(), T(u(d)));
  }
  async function P() {
    if (u(g))
      try {
        const V = await fetch(`/api/caal/sessions/${encodeURIComponent(h())}`);
        if (V.ok) {
          const oe = await V.json();
          S(Q, oe.messages ?? []), S(v, !0);
        }
      } catch {
      }
  }
  function _(V) {
    const oe = V.detail;
    window.dispatchEvent(new CustomEvent("caal:apply-proposal", { detail: oe })), S(O, null), S(f, [
      ...u(f),
      {
        role: "assistant",
        content: `Proposal "${oe.description}" accepted and applied to graph.`,
        timestamp: Date.now()
      }
    ]);
  }
  ...
  qe(() => Xe(c()), () => {
    S(a, c() ? M.filter((V) => V.intent !== "modify") : M);
  }), Pi(), _t();
  var C = cP();
  let ee;
  var ie = w(C), H = y(w(ie), 2), U = w(H);
  {
    var le = (V) => {
      var oe = F_();
      te("click", oe, $), A(V, oe);
  ...
  var se = y(U, 2);
  {
    var de = (V) => {
      var oe = H_();
      te("click", oe, P), A(V, oe);
    };
    J(se, (V) => {
      u(g) && V(de);
    });
  }
  var be = y(se, 2), ae = w(be), we = y(ie, 2);
  {
    var Ce = (V) => {
      var oe = hP(), ce = De(oe), Oe = w(ce), pe = w(Oe), $e = y(Oe, 4), He = w($e), je = y($e, 4), it = w(je), Be = y(ce, 2);
      {
        var mt = (N) => {
          var j = J_(), ne = w(j), fe = y(w(ne), 2), Re = y(ne, 2);
          et(Re, 5, () => u(Q), Je, (Ge, Se) => {
            var K = K_(), ue = w(K), ye = w(ue);
            G(() => {
              Jt(K, 1, `message ${u(Se), b(() => u(Se).role) ?? ""}`, "svelte-vtqea"), B(ye, (u(Se), b(() => u(Se).content)));
            }), A(Ge, K);
          }), te("click", fe, () => S(v, !1)), A(N, j);
        }, Te = (N) => {
          var j = aP(), ne = De(j), fe = w(ne);
          {
            var Re = (xe) => {
              var Pe = eP(), Wt = w(Pe);
              {
            ...
            J(fe, (xe) => {
              u(f), b(() => u(f).length === 0) && xe(Re);
            });
          }
          var Ge = y(fe, 2);
          et(Ge, 1, () => u(f), Je, (xe, Pe) => {
            var Wt = rP(), pt = w(Wt);
            {
              var Pn = (qt) => {
                var Hn = nP();
                et(
                  ...
                  (Tr, lt) => {
                    var Xt = ji(), Yi = De(Xt);
                    {
                      var Cr = (fn) => {
                        var un = tP(), Cs = w(un);
                        G(() => B(Cs, (u(lt), b(() => u(lt).value)))), te("click", un, () => D(u(lt).value)), A(fn, un);
                      }, Vt = (fn) => {
                        var un = iP(), Cs = w(un);
                        G(() => B(Cs, (u(lt), b(() => u(lt).value)))), A(fn, un);
                      };
                      J(Yi, (fn) => {
                        u(lt), b(() => u(lt).type === "chip") ? fn(Cr) : fn(Vt, -1);
                      });
                    }
                    A(Tr, Xt);
                  }
                ...
                var Hn = sP(), Tr = w(Hn);
                G(() => B(Tr, (u(Pe), b(() => u(Pe).content)))), A(qt, Hn);
              };
              J(pt, (qt) => {
                u(Pe), b(() => u(Pe).role === "assistant") ? qt(Pn) : qt(Mt, -1);
              });
            }
            G(() => Jt(Wt, 1, `message ${u(Pe), b(() => u(Pe).role) ?? ""}`, "svelte-vtqea")), A(xe, Wt);
          });
          var Se = y(Ge, 2);
          {
            var K = (xe) => {
          ...
          var Ye = y(ue, 2);
          et(Ye, 5, () => u(a), Je, (xe, Pe) => {
            var Wt = lP(), pt = w(Wt);
            G(() => {
              Wt.disabled = u(p), B(pt, (u(Pe), b(() => u(Pe).label)));
            }), te("click", Wt, () => T(u(Pe).prompt, u(Pe).intent)), A(xe, Wt);
          });
          ...
          G(
            (xe) => {
              _e.disabled = u(p), Ue.disabled = xe;
            },
            [
              () => (u(p), u(d), b(() => u(p) || !u(d).trim()))
            ]
          ), It(_e, () => u(d), (xe) => S(d, xe)), te("keydown", _e, k), te("click", Ue, () => T(u(d))), A(N, j);
        };
        J(Be, (N) => {
          u(v) ? N(mt) : N(Te, -1);
        });
      ...
      G(
        (N, j) => {
          B(pe, `${N ?? ""} node${j ?? ""}`), B(He, (n(), b(() => n() ? n().label || n().type : "no selection"))), Jt(je, 1, `run-status run-status-${s(), b(() => s().status) ?? ""}`, "svelte-vtqea"), B(it, `last run: ${s(), b(() => s().status) ?? ""}`);
        },
        [
  ...
  G(() => {
    ee = Jt(C, 1, "caal-panel svelte-vtqea", null, ee, { collapsed: !u(m) }), B(ae, u(m) ? "▼" : "▲");
  }), te("click", be, () => S(m, !u(m))), A(i, C), kt(), l();
}
...
function SP(i, e) {
  ...
  var f = ji(), d = De(f);
  {
    var p = (O) => {
      ...
      {
        var M = (T) => {
          var R = wP(), Z = w(R), z = y(w(Z), 2), D = w(z), L = y(z, 2), W = y(Z, 2);
          {
            var k = (X) => {
              var C = OP();
              A(X, C);
              ...
              var C = yP();
              et(C, 5, () => u(o), Je, (ee, ie) => {
                var H = bP(), U = w(H), le = w(U), se = w(le), de = y(le, 2), be = w(de), ae = y(de, 2);
                {
                  var we = (Oe) => {
                    var pe = vP(), $e = w(pe);
                    G(() => B($e, `${u(ie), b(() => u(ie).count) ?? ""} items`)), A(Oe, pe);
                  };
                  J(ae, (Oe) => {
                    u(ie), b(() => u(ie).count !== void 0) && Oe(we);
                  });
                }
                var Ce = y(ae, 2), V = w(Ce), oe = y(U, 2), ce = w(oe);
                G(
                  (Oe, pe) => {
                    B(se, (u(ie), b(() => u(ie).key))), B(be, (u(ie), b(() => u(ie).accumulationType))), B(V, `~${Oe ?? ""}t`), B(ce, pe);
                  },
                  [
                    () => (u(ie), b(() => h(u(ie).value))),
                    () => (u(ie), b(() => c(u(ie).value)))
            ...
            J(W, (X) => {
              u(r) ? X(k) : u(l) ? X(P, 1) : (u(o), b(() => u(o).length === 0) ? X(_, 2) : X($, -1));
            });
          }
          G(() => {
            B(D, n()), L.disabled = u(r);
          }), te("click", L, a), A(T, R);
        };
        J(x, (T) => {
          u(s) && T(M);
...
function LP(i, e) {
  ...
  async function f() {
    S(n, !0), S(c, null);
    try {
      const k = await fetch("/api/prompts");
      if (!k.ok) throw new Error(`${k.status}`);
      const P = await k.json();
      S(s, P.map((_) => ({ name: _.name, activeVersion: _, versions: [] })));
    } catch (k) {
      S(c, k.message);
    } finally {
      S(n, !1);
  ...
  async function d(k) {
    const P = await fetch(`/api/prompts/${encodeURIComponent(k)}/versions`);
    if (!P.ok) throw new Error(`${P.status}`);
    const _ = await P.json();
    S(s, u(s).map(($) => $.name === k ? { ...$, versions: _ } : $));
  }
  async function p(k, P) {
    try {
      const _ = await fetch(`/api/prompts/${encodeURIComponent(k)}/versions/${P}/promote`, { method: "POST" });
  ...
  async function O() {
    if (!(!u(o) || !u(l)))
      try {
        ...
        if (!k.ok) throw new Error(`${k.status}`);
        const P = u(o);
        S(a, !1), S(o, ""), S(l, ""), await f(), u(r).has(P) && await d(P);
      } catch (k) {
        S(c, k.message);
      }
  }
  async function g(k) {
    if (u(r).has(k)) {
      u(r).delete(k), S(r, new Set(u(r)));
      return;
    }
    u(r).add(k), S(r, new Set(u(r)));
    try {
      await d(k);
    } catch (P) {
      S(c, P.message);
  ...
  function m(k, P, _) {
    S(h, { name: k, v1: P, v2: _ });
  }
  qe(() => (u(t), u(s)), () => {
    u(t) && u(s).length === 0 && f();
  }), Pi(), _t();
  var v = jP(), Q = De(v), x = w(Q), M = y(w(x), 2), T = w(M), R = y(x, 2);
  {
    var Z = (k) => {
      var P = RP(), _ = w(P);
      {
        var $ = (H) => {
          ...
          var U = AP();
          et(U, 5, () => u(s), Je, (le, se) => {
            var de = EP(), be = w(de), ae = w(be);
            let we;
            var Ce = y(ae, 2), V = w(Ce), oe = y(Ce, 2), ce = w(oe), Oe = y(oe, 2), pe = w(Oe), $e = y(be, 2);
            {
              var He = (it) => {
                var Be = ZP();
                et(Be, 5, () => (u(se), b(() => u(se).versions ?? [])), Je, (mt, Te) => {
                  var N = CP(), j = De(N);
                  let ne;
                  var fe = w(j), Re = w(fe), Ge = y(fe, 2);
                  {
                    var Se = (xe) => {
                      var Pe = _P();
                      A(xe, Pe);
                      ...
                      var Pe = PP();
                      te("click", Pe, () => p(u(se).name, u(Te).id)), A(xe, Pe);
                    };
                    J(Ge, (xe) => {
                      u(Te), b(() => u(Te).isActive) ? xe(Se) : xe(K, -1);
                    });
                  }
                  var ue = y(Ge, 2);
                  {
                    var ye = (xe) => {
                      var Pe = TP();
                      te("click", Pe, () => m(u(se).name, u(se).activeVersion, u(Te))), A(xe, Pe);
                    };
                    J(ue, (xe) => {
                      u(se), u(Te), b(() => u(se).activeVersion && !u(Te).isActive) && xe(ye);
                    });
                  }
                  var Ye = y(ue, 2), Me = w(Ye), _e = y(j, 2), Ue = w(_e);
                  G(
                    (xe, Pe) => {
                      ne = Jt(j, 1, "version-row svelte-ojvpsl", null, ne, { active: u(Te).isActive }), B(Re, `v${u(Te), b(() => u(Te).versionNumber) ?? ""}`), B(Me, xe), B(Ue, `${Pe ?? ""}${u(Te), b(() => u(Te).content.length > 120 ? "…" : "") ?? ""}`);
                    },
                    [
                      () => (u(Te), b(() => new Date(u(Te).createdAt).toLocaleDateString())),
                      () => (u(Te), b(() => u(Te).content.slice(0, 120)))
                    ]
                  ), A(mt, N);
                }), A(it, Be);
              }, je = /* @__PURE__ */ ws(() => (u(r), u(se), b(() => u(r).has(u(se).name))));
              J($e, (it) => {
                u(je) && it(He);
              });
            }
            G(
              (it) => {
                we = Jt(ae, 1, "active-dot svelte-ojvpsl", null, we, { active: u(se).activeVersion !== null }), B(V, (u(se), b(() => u(se).name))), B(ce, `v${u(se), b(() => {
                  var Be;
                  return ((Be = u(se).activeVersion) == null ? void 0 : Be.versionNumber) ?? "—";
                }) ?? ""}`), B(pe, it);
              },
              [
                () => (u(r), u(se), b(() => u(r).has(u(se).name) ? "▼" : "▶"))
              ]
            ), te("click", be, () => g(u(se).name)), A(le, de);
          }), A(H, U);
        };
        J(_, (H) => {
          u(n) ? H($) : u(c) ? H(X, 1) : (u(s), b(() => u(s).length === 0) ? H(C, 2) : H(ee, -1));
        });
      }
      var ie = y(_, 2);
      te("click", ie, () => S(a, !0)), A(k, P);
    };
    J(R, (k) => {
      u(t) && k(Z);
    });
  ...
  {
    var D = (k) => {
      var P = MP(), _ = w(P), $ = y(w(_), 2), X = y(w($)), C = y($, 2), ee = y(w(C));
      nt(ee, "rows", 6);
      var ie = y(C, 2), H = w(ie), U = y(H, 2);
      It(X, () => u(o), (le) => S(o, le)), It(ee, () => u(l), (le) => S(l, le)), te("click", H, () => S(a, !1)), te("click", U, O), te("click", P, Eh(() => S(a, !1))), A(k, P);
    };
    J(z, (k) => {
      u(a) && k(D);
    });
  ...
  {
    var W = (k) => {
      var P = XP(), _ = w(P), $ = w(_), X = w($), C = y($, 2), ee = w(C), ie = w(ee), H = w(ie), U = y(ie, 2), le = w(U), se = y(ee, 2), de = w(se), be = w(de), ae = y(de, 2), we = w(ae), Ce = y(C, 2), V = w(Ce), oe = y(V, 2), ce = w(oe);
      G(() => {
        B(X, `Diff: ${u(h), b(() => u(h).name) ?? ""}`), B(H, `Active (v${u(h), b(() => u(h).v1.versionNumber) ?? ""})`), B(le, (u(h), b(() => u(h).v1.content))), B(be, `v${u(h), b(() => u(h).v2.versionNumber) ?? ""}`), B(we, (u(h), b(() => u(h).v2.content))), B(ce, `Promote v${u(h), b(() => u(h).v2.versionNumber) ?? ""}`);
      }), te("click", V, () => S(h, null)), te("click", oe, () => {
        p(u(h).name, u(h).v2.id), S(h, null);
      }), te("click", P, Eh(() => S(h, null))), A(k, P);
    };
    J(L, (k) => {
      u(h) && k(W);
    });
  }
  G(() => B(T, u(t) ? "▼" : "▶")), te("click", x, () => {
    S(t, !u(t));
  }), A(i, v), kt();
}
...
function KP(i, e) {
  ...
  let s = /* @__PURE__ */ q(!1), r = /* @__PURE__ */ q(!1), o = /* @__PURE__ */ q(null), l = /* @__PURE__ */ q(!1), a = /* @__PURE__ */ q([]), h = /* @__PURE__ */ q(null), c = /* @__PURE__ */ q(!1), f = /* @__PURE__ */ q(null), d = /* @__PURE__ */ q({
    name: "",
    inputJson: `{
  ...
  async function O() {
    S(l, !0), S(h, null), S(f, null);
    try {
      const P = await fetch(`/api/agents/${t()}/test-cases/run`, { method: "POST" });
      if (!P.ok) throw new Error(`${P.status}`);
      S(h, await P.json()), await p();
    } catch (P) {
      S(f, P.message);
    } finally {
      S(l, !1);
  ...
  async function g() {
    try {
      ...
      if (u(d).assertionType === "exact_match")
        try {
          P.expected = JSON.parse(u(d).assertionExpected);
        } catch {
          P.expected = u(d).assertionExpected;
        }
      else u(d).assertionType === "evaluate_score" && (P.threshold = u(d).assertionThreshold);
  ...
  async function m(P) {
    try {
      await fetch(`/api/agents/${t()}/test-cases/${P}`, { method: "DELETE" }), await p();
    } catch {
    }
  }
  function v(P) {
  ...
  var Q = HP(), x = De(Q), M = w(x), T = y(w(M), 2);
  {
    var R = (P) => {
      var _ = IP(), $ = w(_);
      G(() => B($, (u(a), b(() => u(a).length)))), A(P, _);
    };
    J(T, (P) => {
      u(a), b(() => u(a).length > 0) && P(R);
    });
  }
  var Z = y(T, 2), z = w(Z), D = y(M, 2);
  {
    var L = (P) => {
      var _ = BP(), $ = w(_);
      {
        var X = (ae) => {
          ...
          var V = w(we), oe = y(V);
          {
            var ce = (Oe) => {
              var pe = Ch();
              G(() => B(pe, `— ${u(h), b(() => u(h).failed) ?? ""} failed`)), A(Oe, pe);
            };
            J(oe, (Oe) => {
              u(h), b(() => u(h).failed > 0) && Oe(ce);
            });
          }
          G(
            (Oe) => {
              Ce = Jt(we, 1, "suite-summary svelte-1bw2oss", null, Ce, {
                passed: u(h).failed === 0,
                failed: u(h).failed > 0
              }), B(V, `Suite: ${Oe ?? ""} passed `);
            },
      ...
      var C = y($, 2);
      {
        var ee = (ae) => {
          ...
          var we = VP();
          et(we, 5, () => u(a), Je, (Ce, V) => {
            const oe = /* @__PURE__ */ wt(() => (u(h), u(V), b(() => {
              var N, j;
              return (j = (N = u(h)) == null ? void 0 : N.results) == null ? void 0 : j.find((ne) => ne.id === u(V).id);
            })));
            var ce = qP(), Oe = w(ce);
            let pe;
            var $e = y(Oe, 2), He = w($e), je = y($e, 2), it = w(je), Be = y(je, 2);
            {
              var mt = (N) => {
                var j = WP();
                A(N, j);
            ...
            G(() => {
              var N, j, ne, fe;
              pe = Jt(Oe, 1, "status-dot svelte-1bw2oss", null, pe, {
                pass: ((N = u(oe)) == null ? void 0 : N.passed) === !0 || ((j = u(V).lastResult) == null ? void 0 : j.passed) === !0,
                fail: ((ne = u(oe)) == null ? void 0 : ne.passed) === !1 || ((fe = u(V).lastResult) == null ? void 0 : fe.passed) === !1
              }), B(He, (u(V), b(() => u(V).name))), B(it, `${u(V), b(() => (u(V).assertions ?? []).length) ?? ""} assertions`);
            }), te("click", Te, () => m(u(V).id)), A(Ce, ce);
          }), A(ae, we);
        };
        J(C, (ae) => {
          u(r) ? ae(ee) : u(f) ? ae(ie, 1) : (u(a), b(() => u(a).length === 0) ? ae(H, 2) : ae(U, -1));
        });
      }
      var le = y(C, 2), se = w(le), de = y(se, 2), be = w(de);
      G(() => {
        de.disabled = (u(l), u(a), b(() => u(l) || u(a).length === 0)), B(be, u(l) ? "Running…" : "Run Suite");
      }), te("click", se, () => S(c, !0)), te("click", de, O), A(P, _);
    };
    J(D, (P) => {
      u(s) && P(L);
    });
  ...
  {
    var k = (P) => {
      var _ = FP(), $ = w(_), X = y(w($), 2), C = y(w(X)), ee = y(X, 2), ie = y(w(ee));
      nt(ie, "rows", 5);
      var H = y(ee, 2), U = y(w(H), 2), le = w(U), se = w(le);
      se.value = se.__value = "exact_match";
      var de = y(se);
      de.value = de.__value = "schema";
      var be = y(de);
      be.value = be.__value = "evaluate_score";
      var ae = y(le, 2), we = y(U, 2);
      {
        var Ce = (pe) => {
          var $e = GP();
          It($e, () => u(d).assertionExpected, (He) => Zn(d, u(d).assertionExpected = He)), A(pe, $e);
        }, V = (pe) => {
          var $e = UP(), He = y(w($e));
          It(He, () => u(d).assertionThreshold, (je) => Zn(d, u(d).assertionThreshold = je)), A(pe, $e);
        };
        J(we, (pe) => {
          u(d), b(() => u(d).assertionType === "exact_match") ? pe(Ce) : (u(d), b(() => u(d).assertionType === "evaluate_score") && pe(V, 1));
        });
      }
      var oe = y(H, 2), ce = w(oe), Oe = y(ce, 2);
      G(() => Oe.disabled = (u(d), b(() => !u(d).name))), It(C, () => u(d).name, (pe) => Zn(d, u(d).name = pe)), It(ie, () => u(d).inputJson, (pe) => Zn(d, u(d).inputJson = pe)), wl(le, () => u(d).assertionType, (pe) => Zn(d, u(d).assertionType = pe)), It(ae, () => u(d).assertionKey, (pe) => Zn(d, u(d).assertionKey = pe)), te("click", ce, () => S(c, !1)), te("click", Oe, g), te("click", _, Eh(() => S(c, !1))), A(P, _);
    };
    J(W, (P) => {
      u(c) && P(k);
    });
  }
  G(() => B(z, u(s) ? "▼" : "▶")), te("click", M, () => {
    S(s, !u(s));
  }), A(i, Q), kt();
}
...
function e2(i, e) {
  St(e, !1);
  const t = () => ct(ot, "$graph", s), n = () => ct(Wn, "$selectedNode", s), [s, r] = $n();
  let o = ze(e, "agentId", 8), l = /* @__PURE__ */ q(!1), a = /* @__PURE__ */ q(""), h = /* @__PURE__ */ q(null), c = /* @__PURE__ */ q(null);
  Un(async () => {
    if (o()) {
      try {
        const [C, ee, ie] = await Promise.all([
          fetch(`/api/agents/${o()}`),
          fetch(`/api/agents/${o()}/versions`),
          fetch(`/api/agents/${o()}/config`)
        ]);
        let H = null;
        if (C.ok && (H = await C.json(), fl.set(H), S(l, (H == null ? void 0 : H.authoringMode) === "code-defined"), S(a, (H == null ? void 0 : H.handle) ?? ""), u(l) && S(h, (H == null ? void 0 : H.updatedAt) ?? null)), H != null && H.draftGraphJson)
          ot.set(JSON.parse(H.draftGraphJson));
        else if (ee.ok) {
          const U = await ee.json();
          if (U.length > 0) {
            const le = U[U.length - 1];
            ot.set(JSON.parse(le.graphJson ?? "{}"));
          }
        }
        if (u(l) && ot.update((U) => Jp(U)), ie.ok) {
          const le = (await ie.json()).triggerConfig ?? {};
          Rs.set({
            triggerType: le.type ?? "rest",
            description: "",
            cronExpression: le.expression ?? "",
            webhookUrl: le.webhookUrl ?? ""
          });
        }
      } catch {
      }
  ...
  function p(C) {
    ...
    B1(structuredClone(t()), ee.description, () => {
      ot.update((ie) => {
        const H = structuredClone(ie);
        for (const U of ee.patches)
          if (U.op === "add_node" && U.data) {
            const le = U.data;
            H.nodes[le.id] = le;
          } else if (U.op === "update_node" && U.target && U.data) {
            const le = H.nodes[U.target];
            le && (H.nodes[U.target] = { ...le, ...U.data });
          } else if (U.op === "delete_node" && U.target)
            delete H.nodes[U.target];
          else if (U.op === "add_edge" && U.data)
            H.edges = [...H.edges ?? [], U.data];
          else if (U.op === "delete_edge" && U.data) {
            const { from: le, to: se } = U.data;
            H.edges = (H.edges ?? []).filter((de) => {
              const be = de;
              return !(be.from === le && be.to === se);
            });
          } else U.op === "add_tool_edge" && U.data && (H.toolEdges = [...H.toolEdges ?? [], U.data]);
        return H;
      });
    });
  }
  ...
  }), G(() => m = Jt(g, 1, "palette svelte-13r820j", null, m, { readonly: u(l) })), A(i, O), kt(), r();
}

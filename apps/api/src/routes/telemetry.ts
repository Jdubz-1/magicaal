...
import { getTelemetry, getTokenUsage, getTrajectory, getRoutingEvents, getEvaluateScores } from '../controllers/telemetry.controller';
...
telemetryRouter.get('/evaluate-scores', getEvaluateScores);
